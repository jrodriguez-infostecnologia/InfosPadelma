create PROCEDURE [dbo].[spSeleccionaMovimientosResultadoProductoMostrar]
	@producto	int,
	@empresa int
AS
/***************************************************************************
Nombre: spSeleccionaMovimientosResultadoProductoMostrar
...
*****************************************************************************/
	...
	where
	a.resultado = 1 and  a.mCalcular=1 and 
