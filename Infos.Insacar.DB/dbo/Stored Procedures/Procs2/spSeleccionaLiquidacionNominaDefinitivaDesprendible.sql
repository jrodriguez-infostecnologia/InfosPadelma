CREATE proc [dbo].[spSeleccionaLiquidacionNominaDefinitivaDesprendible]
@empresa int,
@año int,
@periodo int,
@numero varchar(50),
...
--if not exists(select * from #temporal)
--begin
insert #temporal
select   a.identificacion, a.codTercero, a.nombreTercero, a.codCCosto, a.nombreCcosto, a.sueldo, a.nombreCargo, a.codConcepto,
...
and valorTotal>0  
and a.noPeriodo=@periodo and a.año=@año and a.anulado=0 and a.numero like '%'+ @numero+ '%'
and convert(date,b.fecha) between @fechaInicial and @fechaFinal
and a.mayor like '%'+ @ccostoMayor+ '%' and a.codCCosto like '%'+ @ccosto+ '%' 
--end
