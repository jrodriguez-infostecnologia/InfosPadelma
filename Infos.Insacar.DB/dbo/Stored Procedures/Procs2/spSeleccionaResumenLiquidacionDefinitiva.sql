CREATE proc [dbo].[spSeleccionaResumenLiquidacionDefinitiva]
@empresa int,
@año int,
@periodo int,
@numero varchar(50)
...
select b.empresa,b.mayor,c.descripcion nombreMayor, b.codigo codigoCentroCostoClase,b.descripcion nombreCentroCostoClase,a.codConcepto concepto, d.descripcion nombreConcepto,
 ...
 a.noPeriodo, COUNT(a.codtercero) noTrabajador,
...
group by b.empresa,b.mayor,c.descripcion, b.codigo,b.descripcion,a.codconcepto,a.noPeriodo,
 d.descripcion ,a.signo, a.fecha, a.fechaInicial, a.fechaFinal, a.año, a.mes,a.tipoConcepto, a.desTipoConcepto