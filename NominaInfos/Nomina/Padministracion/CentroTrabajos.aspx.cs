...
public partial class Nomina_Padministracion_CentroTrabajos : System.Web.UI.Page
{
    #region Instancias
    ...
    private void GetEntidad()
    {
        try
        {
            ...
            this.gvLista.DataSource = centroTrabajo.BuscarEntidad(nitxtBusqueda.Text, Convert.ToInt16(Session["empresa"]));
    ...
    protected void lbRegistrar_Click(object sender, ImageClickEventArgs e)
    {
        if (this.txtDescripcion.Text.Length == 0 || this.txtCodigo.Text.Length == 0)
        {
            ...
            //if (Convert.ToDecimal(txvPorcentaje.Text) == 0)
            //{
            //    this.nilblInformacion.Text = "No de días de termino fijo debe ser mayor a cero(0)";
            //    return;
            //}
