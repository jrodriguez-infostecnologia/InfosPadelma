    ...
    <form id="form1" runat="server">
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="width: 120px; text-align: center;" rowspan="2">
                                            <img src="../Imagen/IconV20/Modulos/iconoBannerPorteria.png" alt="InfoS" style="width: 60px" /><br />
                                            <asp:Label ID="lbModulo" runat="server" Font-Size="12pt" Style="font-weight: 700">Porteria</asp:Label>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
       ...
       <div id="menu">
            <ul id="nav">
                ...
                <li class="" style="text-align: left"><a class="" href="#">Entrada Vehículos</a>
                    <ul class="submenu">
                        <li><a href="#" onclick="addTab('Entrada MP','Padministracion/EntradaMp.aspx',true)">Materia Prima</a></li>
                        <li><a href="#" onclick="addTab('Entrada DPT','Padministracion/EntradaDPT.aspx',true)">Producto Terminado</a></li>
                    </ul>
                </li>
                <li class="" style="text-align: left"><a class="" href="#">Salida de Vehículos</a>
                    <ul class="submenu">
                        <li><a href="#" onclick="addTab('Salidas','Padministracion/Salidas.aspx',true)">Salidas</a></li>
                    </ul>
                </li>
                <li ><a href="#" onclick="addTab('Visualizacion','Pinformes/Visualizacion.aspx',true)">Visualización</a></li>
