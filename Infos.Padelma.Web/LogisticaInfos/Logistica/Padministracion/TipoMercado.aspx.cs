...
public partial class Logistica_Padministracion_TipoMercado : System.Web.UI.Page
{
    #region Instancias

    AccesoDatos.AccesoDatos CentidadMetodos = new AccesoDatos.AccesoDatos();
    SeguridadInfos.Security seguridad = new SeguridadInfos.Security();
    CtipoMercado tipoMercado = new CtipoMercado();
    CIP ip = new CIP();
    ...
    private void GetEntidad()
    {
        try
        {
            ...
            this.gvLista.DataSource = tipoMercado.BuscarEntidad(nitxtBusqueda.Text, Convert.ToInt16(Session["empresa"]));
    ...
    private void Consecutivo()
    {
        try
        {
            this.txtCodigo.Text = tipoMercado.Consecutivo(Convert.ToInt16(Session["empresa"]));
        }
        catch (Exception ex)
        {
