<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mercado.aspx.cs" Inherits="Logistica_Padministracion_Mercado" %>
            ...
            <table cellspacing="0" style="width: 100%; border-top: silver thin solid; border-bottom: silver thin solid;" id="TABLE1">
                ...
                <tr>
                    ...
                    <td class="nombreCampos">
                        <asp:Label ID="Label4" runat="server" Text="Tipo Mercado" Visible="False"></asp:Label>
                    </td>
                    <td class="Campos">
                        <asp:DropDownList ID="ddlTipoMercado" runat="server" Width="300px" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Visible="False" AutoPostBack="True" OnSelectedIndexChanged="ddlTipoMercado_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td class="bordes">&nbsp;</td>
                </tr>
            ...
            <div class="tablaGrilla">
                <asp:GridView ID="gvLista" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="Grid" OnRowDeleting="gvLista_RowDeleting" PageSize="20" Width="800px" OnPageIndexChanging="gvLista_PageIndexChanging" OnSelectedIndexChanged="gvLista_SelectedIndexChanged1">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="TipoMercado" HeaderText="TipoMercado" ReadOnly="True">
                            <HeaderStyle HorizontalAlign="Left" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" />
                            <ItemStyle HorizontalAlign="Left" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" Width="70px" />
                        </asp:BoundField>
