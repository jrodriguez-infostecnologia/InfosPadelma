            ...
            <table cellspacing="0" style="width: 100%">
                <tr>
                    ...
                    <td style="text-align: left">
                        ...
                        <asp:TextBox ID="niTxtFechaI" runat="server" CssClass="input" Font-Bold="True" ForeColor="Gray" OnTextChanged="niTxtFechaI_TextChanged" AutoPostBack="True"></asp:TextBox>
                    </td>
                    <td class="nombreCampos">
                    ...
                    <td style="text-align: left">
                        ...
                        <asp:TextBox ID="niTxtFechaF" runat="server" CssClass="input" Font-Bold="True" ForeColor="Gray" OnTextChanged="niTxtFechaF_TextChanged" AutoPostBack="True"></asp:TextBox>
                    </td>
