<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Formulacion.aspx.cs" Inherits="Laboratorio_Padministracion_AnalisisItems" %>
        ...
        <div class="principal">
            ...
            <table cellspacing="0" style="width: 100%; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: silver;" id="Table2">
                ...
                <tr>
                    ...
                    <td class="Campos">
                            <asp:TextBox ID="txtCodigo" runat="server" CssClass="input" MaxLength="550" Visible="False" Width="150px"></asp:TextBox>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label11" runat="server" Text="Descripción" Visible="False"></asp:Label>
                    </td>
                    <td class="Campos">
                ...
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label7" runat="server" Text="Tipo tra." Visible="False"></asp:Label>
                    </td>
                    <td class="Campos">
                        <asp:DropDownList ID="ddlTipoTransaccion" runat="server" CssClass="chzn-select" data-placeholder="Seleccione una opción..." Width="300px" Visible="False">
                        </asp:DropDownList>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label10" runat="server" Text="Nivel" Visible="False"></asp:Label>
                    </td>
                    <td class="Campos">
                        <asp:DropDownList ID="ddlNivel" runat="server" CssClass="chzn-select" data-placeholder="Seleccione una opción..." Width="300px" Visible="False" AutoPostBack="True" OnSelectedIndexChanged="ddlNivel_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    ...
                    <td colspan="4" style="text-align: center">
                        <div style="display: inline-block">
                            ...
                            <select runat="server" id="selItems" class="multiselect" multiple="true" name="countries[]" visible="False">
                            </select>
                        </div>
                    </td>
                </tr>
                ...
                <div style="display: inline-block">
                    <asp:GridView ID="gvLista" runat="server" Width="700px" GridLines="None" CssClass="Grid" OnSelectedIndexChanged="gvLista_SelectedIndexChanged" OnRowDeleting="gvLista_RowDeleting" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanging="gvLista_PageIndexChanging" PageSize="20">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="descripcion" HeaderText="Descripci&#243;n" ReadOnly="True" HtmlEncode="False" HtmlEncodeFormatString="False">
                                <HeaderStyle HorizontalAlign="Left" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" />
                                <ItemStyle HorizontalAlign="Left" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" Width="250px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="jerarquia" HeaderText="Nivel">
                            <ItemStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" Width="100px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="tipoTransaccion" HeaderText="Tipo Tra.">
                            <ItemStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" Width="100px" />
                            </asp:BoundField>
                        </Columns>
