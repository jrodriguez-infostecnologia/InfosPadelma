<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Tanques.aspx.cs" Inherits="Laboratorio_Padministracion_Tanques" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title></title><link href="../../css/Formularios.css" rel="stylesheet" />
        ...
        <div class="principal">
            ...
            <table id="TABLE1" cellspacing="0" style="width: 100%; border-top: silver thin solid; border-bottom: silver thin solid;">
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:TextBox ID="txtCodigo" runat="server" AutoPostBack="True" CssClass="input" OnTextChanged="txtConcepto_TextChanged" Visible="False" Width="150px" MaxLength="10"></asp:TextBox>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label6" runat="server" Text="Capacidad" Visible="False"></asp:Label>
                    </td>
                    <td class="Campos">
                        <asp:TextBox ID="txvCapacidad" runat="server" CssClass="input" Visible="False" Width="150px"></asp:TextBox>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                ...
                <asp:GridView ID="gvLista" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="Grid" OnPageIndexChanging="gvLista_PageIndexChanging" OnRowDeleting="gvLista_RowDeleting" OnSelectedIndexChanged="gvLista_SelectedIndexChanged1" PageSize="20" Width="800px">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="item" HeaderText="Producto" ReadOnly="True">
                            <HeaderStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Left" />
                            <ItemStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Left" Width="110px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="capacidad" HeaderText="Capacidad" ReadOnly="True">
                            <HeaderStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Left" />
