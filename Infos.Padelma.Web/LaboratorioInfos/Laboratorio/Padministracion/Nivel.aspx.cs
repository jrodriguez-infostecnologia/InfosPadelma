...
public partial class Laboratorio_Padministracion_Nivel : System.Web.UI.Page
{
    #region Instancias
    ...
    private void GetEntidad()
    {
        try
        {
            ...
            this.gvLista.DataSource = nivel.BuscarEntidad(nitxtBusqueda.Text, Convert.ToInt16(Session["empresa"]));
    ...
    private void EntidadKey()
    {
        ...
        {
            ManejoError("codigo debe ser numerico " ,"C");
        }
    ...
    private void Guardar()
    {
        ...
        try
        {
            ...
            nilblInformacion.Text = "El código debe ser numerico";
            return;
        }
