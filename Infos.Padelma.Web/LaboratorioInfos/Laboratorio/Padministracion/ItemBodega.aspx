<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ItemBodega.aspx.cs" Inherits="Laboratorio_Padministracion_AnalisisItems" %>
            ...
            <table cellspacing="0" style="width: 100%; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: silver;" id="Table2">
                ...
                <tr>
                    ...
                    <td class="nombreCampos">
                        <asp:Label ID="Label7" runat="server" Text="Items" Visible="False"></asp:Label>
                    </td>
                    <td class="Campos">
                ...
                <tr>
                    ...
                    <td colspan="4" style="text-align: center">
                        <div style="display: inline-block">
                            ...
                            <select runat="server" id="selAnalisis" class="multiselect" multiple="true" name="countries[]" visible="False">
                            </select>
                        </div>
                    </td>
                </tr>
