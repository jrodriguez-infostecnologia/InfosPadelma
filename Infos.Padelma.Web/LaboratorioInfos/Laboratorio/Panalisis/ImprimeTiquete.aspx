<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImpresionRemision.aspx.cs" Inherits="Laboratorio_Panalisis_ImprimeRemision" %>
            ...
            <div class="principal">
                ...
                <table cellspacing="0" style="width: 100%">
                    <tr>
                        ...
                        <td style="border-bottom: 1px solid silver; text-align: center;"><strong>Impresión de Remisiones</strong></td>
                        <td style="border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: silver;"></td>
                    </tr>
                </table>
                ...
                <table style="width: 100%; height: 700px;" cellspacing="0">
                    <tr>
                        <td style="vertical-align: top; width: 100%; text-align: left; height: 700px;">
                            <table id="Impresion" cellpadding="0" cellspacing="0" style="width: 100%">
                                <tr>
                                    ...
                                    <td style="width: 500px;">
                                        <div style="text-align: center">
                                            <div style="display: inline-block">
                                                <asp:RadioButtonList ID="rblTipoImpresion" runat="server" RepeatDirection="Horizontal">
                                                    <asp:ListItem Value="REM">Remisión Interna</asp:ListItem>
                                                    <asp:ListItem Value="ORD" Selected="True">Orden de Envio</asp:ListItem>
                                                </asp:RadioButtonList>
                                            </div>
                                        </div>
                                    </td>
                                        ...
                                        <table cellpadding="0" cellspacing="0" style="width: 500px">
                                            ...
                                            <tr>
                                                <td style="text-align: center" colspan="2">
                                                    <asp:ImageButton ID="imbImprimir" runat="server" ImageUrl="~/Imagen/Bonotes/btnImprimir.png"
                                                        Visible="False" ToolTip="Clic para imprimir el documento" OnClick="imbImprimir_Click"
                                                        onmouseout="this.src='../../Imagen/Bonotes/btnImprimir.png'"
                                                        onmouseover="this.src='../../Imagen/Bonotes/btnImprimirN.png'" OnClientClick="this.style.visibility='hidden'" />
                                                    <asp:ImageButton ID="imbImprimirBiocosta" runat="server" ImageUrl="~/Imagen/Bonotes/btnRemisionCom.png"
                                                        Visible="False" ToolTip="Clic para imprimir el documento" OnClick="imbImprimirBiocosta_Click"
                                                        onmouseout="this.src='../../Imagen/Bonotes/btnRemisionCom.png'"
                                                        onmouseover="this.src='../../Imagen/Bonotes/btnRemisionComN.png'" />
                                                    <asp:ImageButton ID="imbImprimirOS" runat="server" ImageUrl="~/Imagen/Bonotes/btnOrdenSalida.png"
                                                        Visible="False" ToolTip="Clic para imprimir el documento" OnClick="imbImprimirOS_Click"
