<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistroAnalisis.aspx.cs" Inherits="Laboratorio_Panalisis_RegistroAnalisis" %>
            ...
            <div class="principal">
                ...
                <table cellspacing="0" style="width: 100%">
                    <tr>
                        ...
                        <td style="width: 500px; text-align: center; vertical-align: middle; height: 25px;" class="auto-style1">Registro de análisis de producto</td>
                            ...
                            <table cellspacing="0" style="width: 100%">
                                <tr>
                                    ...
                                    <td style="vertical-align: top; width: 200px">
                                        <asp:GridView ID="gvTanques" runat="server" AutoGenerateColumns="False" GridLines="None" Width="300px" CssClass="Grid">
                                            <RowStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Left" VerticalAlign="Middle" />
                                            <Columns>
                                                <asp:BoundField DataField="codigo" HeaderText="Id Bodega" ReadOnly="True">
                                        ...
                                        <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False" GridLines="None" Width="500px" CssClass="Grid">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Resultado">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtResultado" runat="server" Width="100px" onkeyup="formato_numero(this)" CssClass="input"></asp:TextBox>
                                                    </ItemTemplate>
                                                    <HeaderStyle BackColor="White" HorizontalAlign="Center" />
