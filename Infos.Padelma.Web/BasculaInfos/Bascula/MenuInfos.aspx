                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="width: 120px; text-align: center;" rowspan="2">
                                            <img src="../Imagen/IconV20/Modulos/iconoBannerBascula.png" alt="InfoS" style="width: 60px" /><br />
                                            <asp:Label ID="lbModulo" runat="server" Font-Size="12pt" Style="font-weight: 700">Bascula</asp:Label>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
        ...
        <div id="menu">
            <ul id="nav">
                ...
                <li class="" style="text-align: left"><a class="" href="#">Operaciones</a>
                    <ul class="submenu">
                        <li><a href="#" onclick="addTab('Materia Prima','Poperaciones/MateriaPrima.aspx',true)">Materia Prima</a></li>
                        <li><a href="#" onclick="addTab('Despachos PT','Poperaciones/Despachos.aspx',true)">Despachos PT</a></li>
                        <li><a href="#" onclick="addTab('Pesajes','Poperaciones/Pesajes.aspx',true)">Pesajes</a></li>
                    </ul>
                </li>

                <li ><a href="#" onclick="addTab('Menu Inf.','Pinformes/Visualizacion.aspx',true)">Menu Informes</a></li>
