...
public partial class Bascula_Poperaciones_ValidaRemisionMPSP : System.Web.UI.Page
{
    ...
    protected void txtRemision_TextChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            if (vehiculos.VerificaRemisionSegundoPeso(
                this.txtRemision.Text, (int)this.Session["empresa"]) == 1)
            {
    ...
    protected void lbRegistrar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        else
        {
            ...
            {
                this.Session["entradamp"] = "ValidaRemisionMPSP.aspx";
                this.Session["placamp"] = Convert.ToString(this.txtRemision.Text);

                this.Session["paginamp"] = "RegistraDatosMPSP.aspx";
