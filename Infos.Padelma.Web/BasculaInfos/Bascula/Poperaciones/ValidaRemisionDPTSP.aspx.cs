...
public partial class Bascula_Poperaciones_ValidaRemisionDPTSP : System.Web.UI.Page
{
    #region Instancias
    ...
    protected void lbRegistrar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            if (vehiculos.VerificaCarnetSegundoPeso(
              this.Session["placa"].ToString(), Convert.ToInt16(Session["empresa"])) == 1)
            {
            ...
            {
                this.Session["entrada"] = "ValidaRemisionDPTSP.aspx";

                this.Session["pagina"] = "RegistraDatosDPTSP.aspx";
    ...
    protected void txtRemision_TextChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            this.Session["placa"] = vehiculos.RetornaNumeroDespachoCarnet(
