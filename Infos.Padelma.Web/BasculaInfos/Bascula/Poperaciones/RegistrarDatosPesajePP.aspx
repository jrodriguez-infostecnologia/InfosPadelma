<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistrarDatosPesajePP.aspx.cs" Inherits="Bascula_Poperaciones_RegitrarDatosPesajePP" %>
            ...
            <table cellspacing="0" style="width: 1000px; border-top: silver thin solid; border-bottom: silver thin solid;" id="TABLE1" >
                ...
                <tr>
                    ...
                    <td style="width: 150px; text-align: left">
                        &nbsp;</td>
                    <td style="width: 350px; text-align: left">
                        <asp:CheckBox ID="chkPropio" runat="server" AutoPostBack="True" OnCheckedChanged="chkPropio_CheckedChanged" Text="Vehículo Interno" />
                    </td>
                    <td style="width: 250px">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="width: 150px; text-align: left; vertical-align: top;">
                        <asp:Label ID="Label2" runat="server" Text="Caja / Remolque "></asp:Label></td>
                ...
                <tr>
                    <td style="width: 250px"></td>
                    <td style="width: 150px; text-align: left">
                        <asp:Label ID="lblCedula" runat="server" Text="C.C. Conductor"></asp:Label></td>
                    <td style="width: 350px; text-align: left">
                ...
                <tr>
                    ...
                    <td style="width: 350px; text-align: left">
                        <asp:DropDownList ID="ddlTercero" runat="server" Width="300px" data-placeholder="Seleccione una opción..." CssClass="chzn-select">
                        </asp:DropDownList></td>
                    <td style="width: 250px"></td>
                </tr>
                <tr>
