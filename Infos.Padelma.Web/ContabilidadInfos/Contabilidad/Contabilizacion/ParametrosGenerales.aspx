                ...
                <tr>
                    ...
                    <td style="text-align: left;" colspan="4">
                        ...
                        <asp:Label ID="Label10" runat="server" Text="Mayor ccosto nomina" Visible="False"></asp:Label></td>
                                  <td width="250px" class="nombreCampos">
                        <asp:DropDownList ID="ddlCcostoMayorNomi" runat="server" Visible="False" Width="250px" data-placeholder="Seleccione una opción..." CssClass="chzn-select" ToolTip="Código nacional de ocupación" AutoPostBack="True" OnSelectedIndexChanged="ddlCcostoMayorNomi_SelectedIndexChanged">
                        </asp:DropDownList>
                                  </td>
                                  <td class="nombreCampos" width="100px">
                        <asp:Label ID="Label11" runat="server" Text="Ccosto nomina" Visible="False"></asp:Label></td>
                                  <td class="nombreCampos" width="150px">
                        <asp:DropDownList ID="ddlCentroCostoNomi" runat="server" Visible="False" Width="250px" data-placeholder="Seleccione una opción..." CssClass="chzn-select" ToolTip="Código nacional de ocupación" AutoPostBack="True" OnSelectedIndexChanged="ddlCentroCostoNomi_SelectedIndexChanged">
                        </asp:DropDownList>
                                  </td>
                              </tr>
                              <tr>
                        ...
                        <asp:CheckBox ID="chkManejaDepartamento" runat="server" AutoPostBack="True" OnCheckedChanged="chkManejaDepartamento_CheckedChanged" Text="Maneja departamento" Visible="False" />
                                  ...
                                  <td class="nombreCampos">
                        <asp:DropDownList ID="ddlDepartamento" runat="server" Visible="False" Width="250px" data-placeholder="Seleccione una opción..." CssClass="chzn-select" ToolTip="Código nacional de ocupación" AutoPostBack="True" OnSelectedIndexChanged="ddlCentroCostoNomi_SelectedIndexChanged">
                        </asp:DropDownList>
                                  </td>
                                  <td class="nombreCampos">
                        <asp:Label ID="Label13" runat="server" Text="Concepto / Labor" Visible="False"></asp:Label>
                                  ...
                                  <td class="nombreCampos">
                        <asp:DropDownList ID="ddlConcepto" runat="server" Visible="False" Width="250px" data-placeholder="Seleccione una opción..." CssClass="chzn-select" ToolTip="Código nacional de ocupación">
                        </asp:DropDownList>
                                  </td>
                              </tr>
                              <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: left;" colspan="4">
                        ...
                        <asp:Label ID="lblCuentaGasto" runat="server" Text="Cuenta débito" Visible="False"></asp:Label>
                                  ...
                                  <td width="250px" class="nombreCampos">
                        <asp:DropDownList ID="ddlCuentaGasto" runat="server" Visible="False" Width="250px" data-placeholder="Seleccione una opción..." CssClass="chzn-select" ToolTip="Código nacional de ocupación">
                        </asp:DropDownList>
                                  </td>
                                  <td class="nombreCampos" width="100px">
                        <asp:Label ID="lblCuentaContable" runat="server" Text="Cuenta activo" Visible="False"></asp:Label>
                                  ...
                                  <td class="nombreCampos" width="150px">
                        <asp:DropDownList ID="ddlCuentaContable" runat="server" Visible="False" Width="250px" data-placeholder="Seleccione una opción..." CssClass="chzn-select" ToolTip="Código nacional de ocupación">
                        </asp:DropDownList>
                                  </td>
                              </tr>
                              <tr>
                        ...
                        <asp:Label ID="lblCentroCosto0" runat="server" Text="Mayor ccosto débito/activo" Visible="False"></asp:Label>
                                  ...
                                  <td class="nombreCampos">
                        <asp:DropDownList ID="ddlCentroCostoMayor" runat="server" Visible="False" Width="250px" data-placeholder="Seleccione una opción..." CssClass="chzn-select" ToolTip="Código nacional de ocupación" AutoPostBack="True" OnSelectedIndexChanged="ddlCentroCostoMayor_SelectedIndexChanged">
                        </asp:DropDownList>
                                  </td>
                                  <td class="nombreCampos">
                        <asp:Label ID="lblCentroCosto" runat="server" Text="Ccosto débito/activo+" Visible="False"></asp:Label>
                                  ...
                                  <td class="nombreCampos">
                        <asp:DropDownList ID="ddlCentroCosto" runat="server" Visible="False" Width="250px" data-placeholder="Seleccione una opción..." CssClass="chzn-select" ToolTip="Código nacional de ocupación">
                        </asp:DropDownList>
                                  </td>
                              </tr>
                              <tr>
                        ...
                        <asp:CheckBox ID="chkTerceroActivo" runat="server" AutoPostBack="True" OnCheckedChanged="chkTerceroActivo_CheckedChanged" Text="Tercero débito / activo" Visible="False" />
                                  ...
                                  <td class="nombreCampos">
                        <asp:DropDownList ID="ddlTercero" runat="server" CssClass="chzn-select" data-placeholder="Seleccione una opción..." ToolTip="Código nacional de ocupación" Visible="False" Width="250px">
                        </asp:DropDownList>
                                  </td>
                                  <td class="nombreCampos">
                        <asp:Label ID="lblCuentaContratista" runat="server" Text="Cuenta contratista" Visible="False"></asp:Label>
                                  ...
                                  <td class="nombreCampos">
                        <asp:DropDownList ID="ddlCuentaContratista" runat="server" Visible="False" Width="250px" data-placeholder="Seleccione una opción..." CssClass="chzn-select" ToolTip="Código nacional de ocupación">
                        </asp:DropDownList>
                                  </td>
                              </tr>
                              <tr>
                        ...
                        <asp:Label ID="lblCuentaCredito" runat="server" Text="Cuenta crédito" Visible="False"></asp:Label>
                                  ...
                                  <td class="nombreCampos">
                        <asp:DropDownList ID="ddlCuentaCredito" runat="server" Visible="False" Width="250px" data-placeholder="Seleccione una opción..." CssClass="chzn-select" ToolTip="Código nacional de ocupación">
                        </asp:DropDownList>
                                  </td>
                                  <td class="nombreCampos">
                        <asp:CheckBox ID="chkTerceroCredito" runat="server" AutoPostBack="True" OnCheckedChanged="chkTerceroCredito_CheckedChanged" Text="Tercero crédito" Visible="False" />
                                  ...
                                  <td class="nombreCampos">
                        <asp:DropDownList ID="ddlTerceroCredito" runat="server" CssClass="chzn-select" data-placeholder="Seleccione una opción..." ToolTip="Código nacional de ocupación" Visible="False" Width="250px">
                        </asp:DropDownList>
                                  </td>
                              </tr>
                              <tr>
                        ...
                        <asp:Label ID="lblCcostoCredito0" runat="server" Text="Mayor ccosto crédito" Visible="False"></asp:Label>
                                  ...
                                  <td class="nombreCampos">
                        <asp:DropDownList ID="ddlCcostoMayorCredito" runat="server" Visible="False" Width="250px" data-placeholder="Seleccione una opción..." CssClass="chzn-select" ToolTip="Código nacional de ocupación" AutoPostBack="True" OnSelectedIndexChanged="ddlCcostoMayorCredito_SelectedIndexChanged">
                        </asp:DropDownList>
                                  </td>
                                  <td class="nombreCampos">
                        <asp:Label ID="lblCcostoCredito" runat="server" Text="Ccosto credito" Visible="False"></asp:Label>
                                  ...
                                  <td class="nombreCampos">
                        <asp:DropDownList ID="ddlCentroCostoCredito" runat="server" Visible="False" Width="250px" data-placeholder="Seleccione una opción..." CssClass="chzn-select" ToolTip="Código nacional de ocupación">
                        </asp:DropDownList>
                                  </td>
                              </tr>
                              <tr>
