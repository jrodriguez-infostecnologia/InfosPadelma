        ...
        <div style="vertical-align: top; width: 1000px;  text-align: center; font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; font-size: 12px; color: #003366;">
            ...
            <table cellspacing="0" style="width: 1000px; border-top-style: solid; border-top-width: 1px; border-top-color: silver; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: silver;" id="TABLE1">
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:TextBox ID="txtCodigo" runat="server" Visible="False" Width="150px" AutoPostBack="True" OnTextChanged="txtCodigo_TextChanged"   CssClass="input" TabIndex="1"></asp:TextBox></td>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <br />
                        <asp:CheckBox ID="chkComercializadora" runat="server" Text="Comercializadora" Visible="False" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 30px"></td>
                ...
                <tr>
                    <td style="width: 30px"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label23" runat="server" Text="Departamento" Visible="False"></asp:Label>
                    </td>
                    <td class="Campos">
                        <asp:DropDownList ID="ddlDepartamento" runat="server" Width="300px" data-placeholder="Seleccione una opción..."  CssClass="chzn-select"  Visible="False" Height="20px" TabIndex="14" AutoPostBack="True" OnSelectedIndexChanged="ddlDepartamento_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td class="nombreCampos">
            ...
            <div style="text-align: center">
                <div style="margin: 10px; padding: 5px; display: inline-block">
                    <asp:GridView ID="gvLista" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="Grid" OnRowDeleting="gvLista_RowDeleting" OnSelectedIndexChanged="gvLista_SelectedIndexChanged" PageSize="20" OnPageIndexChanging="gvLista_PageIndexChanging" Width="950px">
