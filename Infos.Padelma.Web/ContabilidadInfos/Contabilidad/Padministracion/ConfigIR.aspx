<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConfigIR.aspx.cs" Inherits="Facturacion_Padministracion_Clientes1" %>
        ...
        <div style="vertical-align: top; width: 1000px; height: 600px; text-align: center; font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; font-size: 12px; color: #003366;">
            ...
            <table cellspacing="0" style="border-top: silver thin solid; border-bottom: silver thin solid; width: 1000px;">
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:TextBox ID="txtCodigo" runat="server" Visible="False" Width="200px" CssClass="input"></asp:TextBox></td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    <td class="bordes"></td>
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:CheckBoxList ID="rbImpuestoRetencion" runat="server" RepeatColumns="2" Visible="False">
                ...
                <tr>
                    ...
                    <td style="text-align: left">
                        <asp:RadioButtonList ID="rbCaracteristica" runat="server" RepeatColumns="1" Visible="False">
            ...
            <div class="tablaGrilla">
                <div style="display: inline-block">
                    <asp:GridView ID="gvLista" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="Grid" OnRowDeleting="gvLista_RowDeleting" OnSelectedIndexChanged="gvLista_SelectedIndexChanged" PageSize="20" Width="700px" OnPageIndexChanging="gvLista_PageIndexChanging">
