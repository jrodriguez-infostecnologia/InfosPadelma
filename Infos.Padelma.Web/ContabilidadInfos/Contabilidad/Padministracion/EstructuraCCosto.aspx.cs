...
public partial class Contabilidad_Padministracion_EstructuraCCosto : System.Web.UI.Page
{
    ...
    {
        object[] objKey = new object[] { this.txtCodigo.Text, Convert.ToInt16(this.txtCodigo.Text), Convert.ToInt16(this.Session["empresa"]) };
        try
        {
            if (accesoDatos.EntidadGetKey("iDestino", "ppa", objKey).Tables[0].Rows.Count > 0)
            {
    ...
    private void Guardar()
    {
        ...
        try
        {
            ...
            switch (accesoDatos.EntidadInsertUpdateDelete("cEstructuraCCosto", operacion, "ppa", objValores))
            {
                case 0:
    ...
    protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            ...
            if (accesoDatos.EntidadInsertUpdateDelete("cEstructuraCCosto", operacion, "ppa", objValores) == 0)
