<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ItemBodega.aspx.cs" Inherits="Agronomico_Poperaciones_BodegaTransaccion" %>
        ...
        <div class="principal">
            ...
            <table  style="width: 100%; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: silver;" id="Table2">
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:DropDownList ID="ddlItems" runat="server" CssClass="chzn-select" data-placeholder="Seleccione una opción..." Width="350px" Visible="False">
                        </asp:DropDownList>
                    </td>
                    <td class="bordes"></td>
                </tr>
