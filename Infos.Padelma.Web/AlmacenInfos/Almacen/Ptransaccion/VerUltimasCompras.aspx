<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VerUltimasCompras.aspx.cs" Inherits="Facturacion_Padministracion_Clientes1" Theme="Entidades" %>
...
<body style="text-align: center">
    ...
    <div style="vertical-align: top; width: 1000px; height: 600px; text-align: center">
        <table cellspacing="0" style="width: 1200px">
            <tr>
                ...
                <td style="width: 500px; text-align: center">
                    Detalle de las ultimas compras del producto</td>
                    ...
                    <tr>
                        ...
                        <td style="width: 900px"><asp:GridView ID="gvDetalle" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="valorUnitario" DataFormatString="{0:N2}" HeaderText="Vl.UltimaOC">
                                                    <HeaderStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Right"/>
                                                    <ItemStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Right" />                                                
                                                </asp:BoundField>                                                    
                                                ...
                                                <asp:BoundField DataField="UltimoOC" HeaderText="UltimaOC">
                                                    <HeaderStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" />
                                                    <ItemStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="FechaOC" DataFormatString="{0:d}" HeaderText="FechaOC">
                                                    <HeaderStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" />
                                                    <ItemStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="UltimoProveedor" HeaderText="Proveedor">
                                                    <HeaderStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Left" />
                                                    <ItemStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Left" />
                                                </asp:BoundField>
                                            </Columns>
