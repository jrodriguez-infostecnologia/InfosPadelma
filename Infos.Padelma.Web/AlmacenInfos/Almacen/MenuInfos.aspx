                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="width: 120px; text-align: center;" rowspan="2">
                                            <img src="../Imagen/IconV20/Modulos/iconoBannerAlmacen.png" alt="InfoS" style="width: 60px" /><br />
                                            <asp:Label ID="lbModulo" runat="server" Font-Size="12pt" Style="font-weight: 700">Almacen</asp:Label>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
            ...
            <ul id="nav">
                ...
                <li class="" style="text-align: left"><a class="" href="#">Administración</a>
                    <ul class="submenu">
                        ...
                        <li><a href="#" onclick="addTab('Items Bodega','Padministracion/ItemBodega.aspx',true);">Items Bodega</a></li>
