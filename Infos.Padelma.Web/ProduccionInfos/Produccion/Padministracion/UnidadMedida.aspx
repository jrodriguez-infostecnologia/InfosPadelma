<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UnidadMedida.aspx.cs" Inherits="Agronomico_Padministracion_UnidadMedida"  %>
        ...
        <div class="principal">
            ...
            <table cellspacing="0" style="width: 1000px; border-top: silver thin solid; border-bottom: silver thin solid;" id="TABLE1" >
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:TextBox ID="txtCodigo" runat="server" Visible="False" Width="150px" AutoPostBack="True" OnTextChanged="txtConcepto_TextChanged" CssClass="input" MaxLength="50"></asp:TextBox></td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    <td class="bordes">&nbsp;</td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label4" runat="server" Text="Descripción corta" Visible="False"></asp:Label>
                    </td>
                    <td class="Campos">
                        <asp:TextBox ID="txtDescripcionCorta" runat="server" Visible="False" Width="150px" CssClass="input" MaxLength="10"></asp:TextBox></td>
                    <td class="bordes">&nbsp;</td>
                </tr>
                <tr>
                    <td class="bordes"></td>
