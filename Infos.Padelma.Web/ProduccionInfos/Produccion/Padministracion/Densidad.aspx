<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Densidad.aspx.cs" Inherits="Produccion_Padministracion_Densidad" %>
        ...
        <div class="principal">
            ...
            <table id="TABLE1" cellspacing="0" style="width: 100%; border-top: silver thin solid; border-bottom: silver thin solid;">
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:DropDownList ID="ddlItems" runat="server" CssClass="chzn-select" data-placeholder="Seleccione una opción..." Visible="False" Width="300px">
                        </asp:DropDownList>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    ...
                    <td class="nombreCampos">
                        <asp:Label ID="Label5" runat="server" Text="Temperatura" Visible="False"></asp:Label>
                    </td>
                    <td class="Campos">
                        <asp:TextBox ID="txvTemperatura" runat="server" CssClass="input" Visible="False" Width="150px" onkeyup="formato_numero(this)"></asp:TextBox>
                    </td>
                    <td class="auto-style1"></td>
                </tr>
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label6" runat="server" Text="Desidad" Visible="False"></asp:Label>
                    </td>
                    <td class="Campos">
                        <asp:TextBox ID="txvDensidad" runat="server" CssClass="input" Visible="False" Width="150px" onkeyup="formato_numero(this)"></asp:TextBox>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                ...
                <asp:GridView ID="gvLista" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="Grid" OnPageIndexChanging="gvLista_PageIndexChanging" OnRowDeleting="gvLista_RowDeleting" OnSelectedIndexChanged="gvLista_SelectedIndexChanged1" PageSize="20" Width="600px">
                    ...
                    <Columns>
                        <asp:ButtonField ButtonType="Image" CommandName="Select" HeaderText="Edit" ImageUrl="~/Imagen/TabsIcon/pencil.png" Text="Botón">
                            <ItemStyle CssClass="Items" Width="20px" HorizontalAlign="Center" />
                        </asp:ButtonField>
                        ...
                        <asp:BoundField DataField="item" HeaderText="Producto" ReadOnly="True">
                            ...
                            <asp:BoundField DataField="temperatura" HeaderText="Temperatura" ReadOnly="True">
                            <HeaderStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Left" />
                            <ItemStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Left" Width="80px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="densidad" HeaderText="Dencidad" ReadOnly="True">
                            <HeaderStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Left" />
                            <ItemStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Left" Width="80px" />
                        </asp:BoundField>
