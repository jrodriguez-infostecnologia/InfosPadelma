...
public partial class Produccion_Padministracion_CalibracionTanque : System.Web.UI.Page
{
    #region Instancias

    AccesoDatos.AccesoDatos CentidadMetodos = new AccesoDatos.AccesoDatos();
    SeguridadInfos.Security seguridad = new SeguridadInfos.Security();
    Ccalibracion calibracion = new Ccalibracion();
    CIP ip = new CIP();
    ...
    private void GetEntidad()
    {
        try
        {
            ...
            this.gvLista.DataSource = calibracion.BuscarEntidad(nitxtBusqueda.Text, Convert.ToInt16(Session["empresa"]));
    ...
    private void CargarCombos()
    {
        ...
        try
        {
            DataView dvConcepto = CcontrolesUsuario.OrdenarEntidadyActivos(
                CentidadMetodos.EntidadGet("iItems", "ppa"), "descripcion", Convert.ToInt16(Session["empresa"]));
            dvConcepto.RowFilter = "tipo in ('M','T') ";
    ...
    private void Guardar()
    {
        ...
        if (this.ddlMovimientos.SelectedValue.Length == 0 || txvVolumen.Text.Length == 0 || txvAltura.Text.Length == 0)
        {
        ...
        try
        {
            ...
            object[] objValores = new object[]{
                chkActivo.Checked,
                    ...
                    ddlMovimientos.SelectedValue,
                    rblTipo.SelectedValue,
                    Convert.ToDecimal( txvVolumen.Text)
                };
    ...
    protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            object[] objValores = new object[] {
                 Convert.ToDecimal(Server.HtmlDecode(this.gvLista.Rows[e.RowIndex].Cells[4].Text)),
                 Convert.ToInt16(Session["empresa"]),
    ...
    protected void gvLista_SelectedIndexChanged1(object sender, EventArgs e)
    {
        ...
        ddlMovimientos.Enabled = false;
        rblTipo.Enabled = false;
        txvAltura.Enabled = false;
        txvVolumen.Focus();
        ...
        try
        {
            ...
            {
                ddlMovimientos.SelectedValue = Server.HtmlDecode(this.gvLista.SelectedRow.Cells[2].Text);

            }

            if (this.gvLista.SelectedRow.Cells[3].Text != "&nbsp;")
            {
                rblTipo.SelectedValue = Server.HtmlDecode(this.gvLista.SelectedRow.Cells[3].Text);
            }


            if (this.gvLista.SelectedRow.Cells[4].Text != "&nbsp;")
            {
                txvAltura.Text = Server.HtmlDecode(this.gvLista.SelectedRow.Cells[4].Text);
            }
            else
            {
                txvAltura.Text = "0";
            ...
            {
                txvVolumen.Text = Server.HtmlDecode(this.gvLista.SelectedRow.Cells[5].Text);
            }
            else
            {
                txvVolumen.Text = "0";
