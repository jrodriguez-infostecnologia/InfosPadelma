<%@ Page MaintainScrollPositionOnPostback="true" Language="C#" AutoEventWireup="true" CodeFile="ProductoMovimiento.aspx.cs" Inherits="Administracion_Caracterizacion" %>
                            ...
                            <table cellspacing="0" style="width: 700px">
                                <tr>
                                    <td style="border-left-color: dimgray; border-bottom-color: dimgray; vertical-align: top; width: 679px; border-top-color: dimgray; height: 10px; text-align: left; border-right-color: dimgray">
                                        <table cellspacing="0" style="width: 600px; height: 1px">
                                            <tr>
                                                <td style="vertical-align: top; width: 100px; text-align: left">
                                                    <asp:Label ID="nilblProducto0" runat="server" Text="Modulo"></asp:Label>
                                                </td>
                                                <td style="vertical-align: top; width: 300px; text-align: left">
                                                    <asp:DropDownList ID="niddlModulo" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlProducto_SelectedIndexChanged" Width="300px" data-placeholder="Seleccione una opción..." CssClass="chzn-select">
                                                    </asp:DropDownList>
                                                </td>
                                            ...
                                            <tr>
                                                <td style="vertical-align: top; width: 100px; text-align: left">
                                                    <asp:Label ID="nilblProducto" runat="server" Text="Producto"></asp:Label>
                                                </td>
                                                <td style="vertical-align: top; width: 300px; text-align: left">
                                                    <asp:DropDownList ID="niddlProducto" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlProducto_SelectedIndexChanged" Width="300px" data-placeholder="Seleccione una opción..." CssClass="chzn-select">
                                                    </asp:DropDownList>
                                                </td>
                                                <td style="vertical-align: top; width: 300px; text-align: center">
