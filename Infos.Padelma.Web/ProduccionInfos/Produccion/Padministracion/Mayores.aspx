<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mayores.aspx.cs" Inherits="Compras_Padministracion_Mayores" %>
            ...
            <table id="TABLE1" cellspacing="0" style="width: 100%; border-top: silver thin solid; border-bottom: silver thin solid;">
                ...
                <tr>
                    ...
                    <td class="nombreCampos">
                        <asp:Label ID="Label5" runat="server" Text="Planes" Visible="False"></asp:Label>
                    </td>
                    <td class="Campos">
                        <asp:DropDownList ID="ddlPlanes" runat="server" AutoPostBack="True" CssClass="chzn-select" data-placeholder="Seleccione una opción..." OnSelectedIndexChanged="ddlFinca_SelectedIndexChanged" Visible="False" Width="350px">
                        </asp:DropDownList>
                    </td>
                    <td class="bordes">&nbsp;</td>
                </tr>
                ...
                <asp:GridView ID="gvLista" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="Grid" OnPageIndexChanging="gvLista_PageIndexChanging" OnRowDeleting="gvLista_RowDeleting" OnSelectedIndexChanged="gvLista_SelectedIndexChanged1" PageSize="20" Width="800px">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Elim">
                          ...
                          <asp:BoundField DataField="planes" HeaderText="Plan" ReadOnly="True">
