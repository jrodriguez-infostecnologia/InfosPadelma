                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="width: 120px; text-align: center;" rowspan="2">
                                            <img src="../Imagen/IconV20/Modulos/iconoBannerProduccion.png" alt="InfoS" style="width: 60px" /><br />
                                            <asp:Label ID="lbModulo" runat="server" Font-Size="12pt" Style="font-weight: 700">Producción</asp:Label>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
        ...
        <div id="menu">
            <ul id="nav">
                ...
                <li class="" style="text-align: left"><a class="" href="#">Administración</a>
                    <ul class="submenu">
                        <li><a href="#" onclick="addTab('Calibración','Padministracion/CalibracionTanque.aspx',true);">Calibración</a></li>
                        <li><a href="#" onclick="addTab('Densidad','Padministracion/Densidad.aspx',true);">Densidad</a></li>
			<li><a href="#" onclick="addTab('UnidadMedida','Padministracion/UnidadMedida.aspx',true)">Unidad de Medida</a></li>
                ...
                <li class="" style="text-align: left"><a class="" href="#">Parametrización</a>
                    <ul class="submenu">
                        <li><a href="#" onclick="addTab('Característica','Padministracion/ProductoMovimiento.aspx',true);">Características</a></li>
                    </ul>
                </li>
		
                <li class="" style="text-align: left"><a class="" href="#">Transacciones</a>
                    <ul class="submenu">
                        <li><a href="#" onclick="addTab('transacción','Padministracion/Transaccion.aspx',true);">Registro</a></li>
                    </ul>
                </li>
               <li class="" style="text-align: left"><a href="#" onclick="addTab('Menu Inf.','Pinformes/Visualizacion.aspx',true)">Informes</a>
                </li>
