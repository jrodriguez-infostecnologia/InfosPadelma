...
public class CnovedadTiquete
{
    ...
    public CnovedadTiquete(string codnovedad, string desnovedad, string codlote, string deslote, string codseccion, string desseccion,
        decimal racimos, decimal cantidad,  List<CterceroTiquete> terceros, List<CterceroTiquete> terceroscargue,  List<CterceroTiquete> tercerostransporte, int registro, string umedida, decimal pesoRacimo, 
        string fechaD, decimal jornal, decimal precioLabor,  int registroNovedad, string novedadCargue,string nombreNovedadCargue, string fechaDCargue, decimal precioCargue,
        string novedadTransporte, string nombrenovedadTransporte ,string fechaDTransporte, decimal precioTransporte)
    {
        ...
        this.novedadCargue = novedadCargue;
        this.nombrenovedadCargue = nombreNovedadCargue;
        this.fechaDcargue = fechaDCargue;
        this.precioCargue = precioCargue;
        this.novedadTransporte = novedadTransporte;
        this.nombrenovedadTransporte = nombrenovedadTransporte;
        this.fechaDTransporte = fechaDTransporte;
        this.precioTransporte = precioTransporte;
        this.tercerosCargue = terceroscargue;
        this.terceroTransporte = tercerostransporte;
