...
public class CterceroTiquete
{
    ...
    public CterceroTiquete(int codTercero, string desTercero, string lote, string cuadrilla, decimal jornal, decimal cantidad, decimal precioLabor, string novedad)
    {
