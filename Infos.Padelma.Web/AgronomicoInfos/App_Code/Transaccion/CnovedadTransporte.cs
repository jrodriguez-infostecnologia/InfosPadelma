...
/// </summary>
public class CnovedadTransporte
{
    ...
    public CnovedadTransporte(string codnovedad, string desnovedad, string codlote, string deslote, string codseccion, string desseccion, decimal racimos, decimal cantidad,
