<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Caracteristicas.aspx.cs" Inherits="Agronomico_Padministracion_GrupoNovedad" %>
        ...
        <div class="principal">
            ...
            <table cellspacing="0" style="width: 100%; border-top: silver thin solid; border-bottom: silver thin solid;" id="TABLE1">
                ...
                <tr>
                    <td class="bordes">&nbsp;</td>
                    <td class="nombreCampos">
                        <asp:CheckBox ID="chkGrupoC" runat="server" Text="Gru. Caracteristico" Visible="False" OnCheckedChanged="chkImpuesto_CheckedChanged" AutoPostBack="True" />
                    </td>
                    <td class="Campos">
                        <asp:DropDownList ID="ddlGrupoC" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="360px" Visible="False">
                        </asp:DropDownList>
                    </td>
                    <td class="bordes">&nbsp;</td>
                </tr>
