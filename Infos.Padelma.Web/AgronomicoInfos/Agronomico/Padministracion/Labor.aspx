     ...
     <div class="principal">
            ...
            <table cellspacing="0" style="width: 1000px; border-top: silver thin solid; border-bottom: silver thin solid;" id="TABLE1">
                ...
                <tr>
                    ...
                    <td style="text-align: left; " colspan="2">
                        <asp:RadioButtonList ID="rblClaseLabor" runat="server" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" RepeatDirection="Horizontal" Visible="False" CssClass="input" RepeatColumns="4">
                            ...
                            <asp:ListItem Value="6">Fertilizante</asp:ListItem>
                        </asp:RadioButtonList>
                        </td>
                    <td class="bordesPeque"></td>
                </tr>
