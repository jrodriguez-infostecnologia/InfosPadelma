            ...
            <ul id="nav">
                ...
                <li class="" style="text-align: left"><a class="" href="#">Transacciones</a>
                    <ul class="submenu">
                        ...
                        <li><a href="#" onclick="window.open('Ptransaccion/RegistroTiqueteCompleto.aspx');">Producción Completa</a> </li>
                        ...
                        <li><a href="#" onclick="window.open('Ptransaccion/Sanidad.aspx');">Control Sanidad</a> </li>
						 <li><a href="#" onclick="window.open('Ptransaccion/RegistroFertilizacion.aspx');">Fertilización</a> </li>
                    </ul>
                </li>
