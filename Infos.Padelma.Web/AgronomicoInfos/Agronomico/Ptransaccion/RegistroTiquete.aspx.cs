                                ...
                                switch (CentidadMetodos.EntidadInsertUpdateDelete("aTransaccionBascula", operacion, "ppa", objValores))
                                {
                                    ...
                                    umedida //@uMedida
                                                ...
                                                switch (CentidadMetodos.EntidadInsertUpdateDelete("aTransaccionNovedad", operacion, "ppa", objValoresCargue))
                                                {
                                                    case 0:
                                                        ...
                                                        for (int x = 0; x < selTerceroCargadores.Items.Count; x++)
                                                        {
                                                            if (selTerceroCargadores.Items[x].Selected)
                                                            {
                                                                precioLabor = listaPrecios.SeleccionaPrecioNovedadAñoTercero(Convert.ToInt32(Session["empresa"]), ddlLaborCargadores.SelectedValue, Convert.ToInt32(fechaDetalle.Year.ToString()), Convert.ToInt32(selTerceroCosecha.Items[x].Value), fechaDetalle);
                                                                object[] objValores2 = new object[]{
                                                                Convert.ToInt32( fechaCargue.Year.ToString()),  //@año
                                                                cantidadT, //@cantidad
                                                                false, //@ejecutado
                                        ...
                                        if (chkLaborTransporte.Checked)
                                        {
                                            ...
                                            precioLabor = listaPrecios.SeleccionaPrecioNovedadAño(Convert.ToInt32(Session["empresa"]), ddlLaborTransporte.SelectedValue, Convert.ToInt32(fechaDetalle.Year.ToString()));
                                            ...
                                            switch (CentidadMetodos.EntidadInsertUpdateDelete("aTransaccionNovedad", operacion, "ppa", objValoresTransporte))
                                            {
                                                case 0:
                                                    ...
                                                    precioLabor = listaPrecios.SeleccionaPrecioNovedadAñoTercero(Convert.ToInt32(Session["empresa"]), ddlLaborTransporte.SelectedValue, Convert.ToInt32(fechaDetalle.Year.ToString()), Convert.ToInt32(ddlConductor.SelectedValue), fechaDetalle);
