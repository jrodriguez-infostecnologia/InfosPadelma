...
public partial class Agronomico_Ptransaccion_RegistroNovedades : System.Web.UI.Page
{
    ...
    protected void cargarLotes()
    {
        try
        {
            ...
            {
                this.ddlLoteD.DataSource = lotes.LotesSeccionFinca(this.ddlSeccionD.SelectedValue.ToString().Trim(), Convert.ToInt32(this.Session["empresa"]), ddlFinca.SelectedValue.ToString().Trim());
    ...
    protected void cargarSesiones()
    {
        ...
        try
        {
            if (ddlSeccionD.Visible == true)
            {
                ...
                this.ddlSeccionD.DataSource = seccion.SeleccionaSesionesFinca(Convert.ToInt32(this.Session["empresa"]), ddlFinca.SelectedValue);
    ...
    private void CargarCombos()
    {
        try
        {
            this.ddlNovedad.DataSource = tipoTransaccion.SeleccionaNovedadTipoDocumentos(ddlTipoDocumento.SelectedValue, Convert.ToInt32(Session["empresa"]));
        ...
        try
        {
            DataView dvUmedida = CcontrolesUsuarios.OrdenarEntidadyActivos(CentidadMetodos.EntidadGet(
                "gUnidadMedida", "ppa"), "descripcion", Convert.ToInt32(Session["empresa"]));
    ...
    private void Editar()
    {
        ...
        //            Server.HtmlDecode(this.txtObservacion.Text.Trim()), Convert.ToInt32(Session["empresa"])))
        //        {
        //            case 0:
        ...
        //                                         Convert.ToInt32(gv.Cells[13].Text),//@registro
        ...
        //                                        Convert.ToInt32(gv.Cells[11].Text),  //frecuencia
        //                                        Convert.ToInt32(gv.Cells[9].Text),    //@periodoInicial
        //                                        Convert.ToInt32(gv.Cells[10].Text), //@periodoFinal
        //                                       Convert.ToInt32(gv.Cells[8].Text),  //@año
    ...
    protected void btnRegistrar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            transaccionNovedad = new CtransaccionNovedad(ddlTercero.SelectedValue, ddlNovedad.SelectedValue, ddlNovedad.SelectedItem.ToString(), ddlTercero.SelectedItem.ToString(), cantidad, ddlUmedida.SelectedValue,
                lote, fecha, jornal, seccion, Convert.ToInt32(this.hdRegistro.Value), false, validaJornal);
    ...
    protected void gvTransaccion_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        //try
        //{
        //    this.hdTransaccionConfig.Value = CcontrolesUsuarios.TipoTransaccionConfig(this.gvTransaccion.Rows[e.RowIndex].Cells[3].Text, Convert.ToInt32(Session["empresa"]));

        //    if (transacciones.VerificaEdicionBorrado(this.gvTransaccion.Rows[e.RowIndex].Cells[3].Text, this.gvTransaccion.Rows[e.RowIndex].Cells[4].Text, Convert.ToInt32(Session["empresa"])) != 0)
        //    {
        ...
        //    CcontrolesUsuarios.LimpiarControles(this.upCabeza.Controls);
        //    CcontrolesUsuarios.ComportamientoCampoEntidad(this.upCabeza.Controls, "nNovedades", Convert.ToString(this.ddlTipoDocumento.SelectedValue), Convert.ToInt32(Session["empresa"]));
        //    CcontrolesUsuarios.LimpiarControles(this.upDetalle.Controls);
        //    CcontrolesUsuarios.ComportamientoCampoEntidad(this.upDetalle.Controls, "nNovedadesDetalle", Convert.ToString(this.ddlTipoDocumento.SelectedValue), Convert.ToInt32(Session["empresa"]));

        //    object[] objCab = new object[] { Convert.ToInt32(Session["empresa"]), this.gvTransaccion.Rows[e.RowIndex].Cells[3].Text, this.gvTransaccion.Rows[e.RowIndex].Cells[2].Text };
        ...
        //        this.gvTransaccion.Rows[e.RowIndex].Cells[2].Text, this.gvTransaccion.Rows[e.RowIndex].Cells[3].Text, Convert.ToInt32(Session["empresa"])))
        //    {
        ...
        //        transaccionNovedad = new CtransaccionNovedad(empleado, concepto, nombreConcepto, nombreEmpleado, cantidad, Convert.ToInt32(detalle.Row.ItemArray.GetValue(8)),
        //            Convert.ToInt32(detalle.Row.ItemArray.GetValue(9)), Convert.ToInt32(detalle.Row.ItemArray.GetValue(10)), Convert.ToInt32(detalle.Row.ItemArray.GetValue(11)),
        //            Convert.ToDecimal(detalle.Row.ItemArray.GetValue(7)), Convert.ToString(detalle.Row.ItemArray.GetValue(12)), Convert.ToInt32(detalle.Row.ItemArray.GetValue(3)), false);
    ...
    private object NovedadConfig(int posicion)
    {
        ...
        try
        {
            cadena = novedades.NovedadConfig(ddlNovedad.SelectedValue, Convert.ToInt32(Session["empresa"])).ToString();
            retorno = cadena.Split(comodin, indice).GetValue(posicion - 1);
    ...
    protected void ddlLote_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            desde = Convert.ToInt32(NovedadConfig(26));
            hasta = Convert.ToInt32(NovedadConfig(27));

            añoSiembra = Convert.ToInt32(LoteConfig(5, ddlLoteD.SelectedValue));

            difAño = Convert.ToInt32(cldFechaD.SelectedDate.Year) - añoSiembra;
