<%@ Page Language="C#" AutoEventWireup="true" Inherits="Agronomico_Padministracion_LiquidacionPrimas" Codebehind="LiquidacionPrimas.aspx.cs" %>
        ...
        <div class="principal">
            ...
            <table cellspacing="0" style="width: 100%; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: silver;" id="Table2">
                ...
                <tr>
                    ...
                    <td style="width: 120px; text-align: left;">
                        <asp:LinkButton ID="lbFecha" runat="server" OnClick="lbFecha_Click"
                            Visible="False" Style="color: #003366">Fecha</asp:LinkButton>
                    </td>
                    <td class="Campos">
                        ...
                        <asp:TextBox ID="txtFecha" runat="server" Font-Bold="True" ForeColor="Gray"
                            Visible="False" CssClass="input" AutoPostBack="True" OnTextChanged="txtFecha_TextChanged"></asp:TextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:DropDownList ID="ddlAñoDesde" runat="server" CssClass="chzn-select" data-placeholder="Seleccione una opción..." Visible="False" Width="130px" AutoPostBack="True" OnSelectedIndexChanged="ddlAño_SelectedIndexChanged1">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 120px; text-align: left;">
                    ...
                    <td style="width: 300px; text-align: left;">
                        <asp:DropDownList ID="ddlPeriodoDesde" runat="server" CssClass="chzn-select" data-placeholder="Seleccione una opción..." Visible="False" Width="320px" AutoPostBack="True" OnSelectedIndexChanged="ddlPeriodo_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 80px"></td>
                </tr>
                <tr>
                    ...
                    <td class="Campos">
                        <asp:DropDownList ID="ddlAñoHasta" runat="server" CssClass="chzn-select" data-placeholder="Seleccione una opción..." Visible="False" Width="130px" AutoPostBack="True" OnSelectedIndexChanged="ddlAñoHasta_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 120px; text-align: left;">
                    ...
                    <td style="width: 300px; text-align: left;">
                        <asp:DropDownList ID="ddlPeriodoHasta" runat="server" CssClass="chzn-select" data-placeholder="Seleccione una opción..." Visible="False" Width="320px" AutoPostBack="True" OnSelectedIndexChanged="ddlPeriodo_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 80px"></td>
                </tr>
                <tr>
                    ...
                    <td style="text-align: left;" colspan="2">
                        <asp:CheckBox ID="chkPagaNomina" runat="server" Text="Paga primas en nomina?" AutoPostBack="True" OnCheckedChanged="chkPagaNomina_CheckedChanged" Visible="False" />
                    </td>
                    <td style="width: 120px; text-align: left;"></td>
                    <td style="width: 300px; text-align: left;"></td>
                    <td style="width: 80px"></td>
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:DropDownList ID="ddlAñoPago" runat="server" CssClass="chzn-select" data-placeholder="Seleccione una opción..." Visible="False" Width="130px" AutoPostBack="True" OnSelectedIndexChanged="ddlAñoPago_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 120px; text-align: left;">
                    ...
                    <td style="width: 300px; text-align: left;">
                        <asp:DropDownList ID="ddlPeriodoPago" runat="server" CssClass="chzn-select" data-placeholder="Seleccione una opción..." Visible="False" Width="320px" AutoPostBack="True" OnSelectedIndexChanged="ddlPeriodo_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 80px"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="4" style="text-align: center;">
                        ...
                        <asp:ImageButton ID="btnLiquidar" runat="server" ImageUrl="~/Imagen/Bonotes/btnLiquidar.png" OnClick="btnLiquidar_Click" OnClientClick="if(!confirm('Desea liquidar el documento ?')){return false;};" onmouseout="this.src='../../Imagen/Bonotes/btnLiquidar.png'" onmouseover="this.src='../../Imagen/Bonotes/btnLiquidarN.png'" ToolTip="Liquidar primas definitivas " Visible="False" />
                    </td>
                    <td style="width: 80px"></td>
                </tr>
                <tr>
