...
public partial class Agronomico_Padministracion_LiquidacionPrimas : System.Web.UI.Page
{
    ...
    private void Liquidar()
    {
        ...
        switch (retorno)
        {
            ...
            case 20:
                ...
                script = "<script language='javascript'>VisualizacionLiquidacion('liquidacionNomina','" + Convert.ToString(ddlAñoDesde.SelectedValue.Trim()) + "','" + Convert.ToString(ddlPeriodoDesde.SelectedValue.Trim()) + "','" + numeroTransaccion + "');</script>";
    ...
    {
        //if (ddlPeriodoDesde.SelectedValue.Trim().Length > 0 & ddlAñoDesde.SelectedValue.Trim().Length > 0)
        //{
    ...
    protected void ddlAñoHasta_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddlAñoHasta.SelectedValue.Trim().Length > 0)
        {
            try
            {
                this.ddlPeriodoHasta.DataSource = periodo.PeriodoNominaAño(Convert.ToInt32(ddlAñoDesde.SelectedValue.Trim()), Convert.ToInt16(Session["empresa"])).Tables[0].DefaultView;
