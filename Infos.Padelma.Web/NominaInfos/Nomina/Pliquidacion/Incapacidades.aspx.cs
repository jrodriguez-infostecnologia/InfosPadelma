...
public partial class Nomina_PLiquidacion_Incapacidades : System.Web.UI.Page
{
    ...
    protected void lbRegistrar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (txtCodigo.Text.Trim().ToString().Length == 0 || ddlTipoIncapacidad.SelectedValue.Length == 0 || ddlConcepto.SelectedValue.Length == 0 || ddlEmpleado.SelectedValue.Length == 0)
        {
