<%@ Page Language="C#" AutoEventWireup="true" Inherits="Agronomico_Padministracion_LiquidacionCesantias" Codebehind="LiquidacionCesantias.aspx.cs" %>
        ...
        <div class="principal">
            ...
            <table cellspacing="0" style="width: 100%; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: silver;" id="Table2">
                ...
                <tr>
                    ...
                    <td style="width: 120px; text-align: left;">
                        <asp:LinkButton ID="lbFecha" runat="server" OnClick="lbFecha_Click"
                            Visible="False" Style="color: #003366">Fecha corte</asp:LinkButton>
                    </td>
                    <td class="Campos">
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:DropDownList ID="ddlAñoDesde" runat="server" CssClass="chzn-select" data-placeholder="Seleccione una opción..." Visible="False" Width="130px">
                        </asp:DropDownList>
                    </td>
                    <td style="text-align: left;" colspan="2">
                        <asp:CheckBox ID="chkPagaNomina" runat="server" Text="Paga cesantias en nomina?" AutoPostBack="True" OnCheckedChanged="chkPagaNomina_CheckedChanged" Visible="False" />
                        <asp:CheckBox ID="chkSueldoActual" runat="server" Text="Sueldo actual o anterior?" Visible="False" />
                    </td>
                    <td style="width: 80px"></td>
                </tr>
                <tr>
