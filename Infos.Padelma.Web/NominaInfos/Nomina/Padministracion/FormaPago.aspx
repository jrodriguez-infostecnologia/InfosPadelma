<%@ Page Language="C#" AutoEventWireup="true" Inherits="Facturacion_Padministracion_FormaPago" Codebehind="FormaPago.aspx.cs" %>
            ...
            <table cellspacing="0" style="width: 1000px; border-top: silver thin solid; border-bottom: silver thin solid;" id="TABLE1">
                ...
                <tr>
                    ...
                    <td class="nombreCampos">
                        &nbsp;</td>
                    <td class="Campos">
                        <asp:CheckBox ID="chkCheque" runat="server" Text="Cheque" Visible="False" />
                    </td>
                    <td class="bordes">&nbsp;</td>
                </tr>
                <tr>
