<%@ Page Language="C#" AutoEventWireup="true" Inherits="Nomina_Paminidtracion_ParametrosGeneral" Codebehind="ParametrosGeneral.aspx.cs" %>
                ...
                <tr>
                    <td>
                        ...
                        <asp:ImageButton ID="lbRegistrar" runat="server" ImageUrl="~/Imagen/Bonotes/btnGuardar.jpg" ToolTip="Guarda el nuevo registro en la base de datos"
                            ...
                            onmouseover="this.src='../../Imagen/Bonotes/btnGuardarN.jpg'" OnClick="lbRegistrar_Click" OnClientClick="if(!confirm('Desea insertar el registro ?')){return false;};" style="height: 21px" />
                    </td>
                </tr>
            </table>
            <div>
                    ...
                    <td>
                        <div style="padding: 5px; text-align: center">
                            <div style="border: 1px solid silver; padding: 8px; display: inline-block;">
                                    ...
                                    <fieldset>
                                        ...
                                        <table cellpadding="0" cellspacing="0" style="width: 950px">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 120px; text-align: left;">
                                                    <asp:LinkButton ID="lbFecha" runat="server" ForeColor="#003366" OnClick="lbFecha_Click">Ultima cesantias</asp:LinkButton>
                                                </td>
                                                <td style="width: 100px; text-align: left;">
                                ...
                                <div>
                                    <fieldset>
                                        <legend>Tipos de transacción Liquidacion</legend>
                                        <div style="text-align: center">
                                            <div style="display: inline-block">
                                                <div style="width: 920px">
                                                    <div style="padding: 8px; display: inline-block;">
                                                        <fieldset style="width: 550px">
                                                            <legend>Tipos de transacción</legend>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" class="auto-style1">
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:DropDownList ID="ddlLiquidacionNomina" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:DropDownList ID="ddlAcumulado" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlLiquidacionContrato" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <div style="padding: 5px">
                                                                <table cellpadding="0" cellspacing="0" class="auto-style1">
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:DropDownList ID="ddlHF" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="260px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlHRF" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="260px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlHEDF" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="260px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlHENF" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="260px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <div style="padding: 5px">
                                                                <table cellpadding="0" cellspacing="0" class="auto-style1">
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlHD" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="260px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlRND" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="260px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlHEDD" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="260px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlHEND" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="260px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <div style="padding: 5px">
                                                                <table cellpadding="0" cellspacing="0" class="auto-style1">
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:DropDownList ID="ddlSueldo" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:DropDownList ID="ddlJornales" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:DropDownList ID="ddlCesantias" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:DropDownList ID="ddlInteresesCesantias" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:DropDownList ID="ddlVacaciones" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:DropDownList ID="ddlPrimas" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:DropDownList ID="ddlSalarioIntegral" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:DropDownList ID="ddlPermisos" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:DropDownList ID="ddlSubsidioTranasporte" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:DropDownList ID="ddlRetroactivo" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:DropDownList ID="ddlRetencion" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:DropDownList ID="ddlSuspencion" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:DropDownList ID="ddlincapacidades" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:DropDownList ID="ddlEmbargos" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:DropDownList ID="ddlGanaDomingoCampo" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:DropDownList ID="ddlSindicato" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:DropDownList ID="ddlPagaFestivo" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <div style="padding: 5px">
                                                                <table cellpadding="0" cellspacing="0" class="auto-style1">
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlCajaCompensacion" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlSalud" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlPension" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlSena" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlICBF" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlARP" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlIndemnizacion" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlEnfermedadMaternidad" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlIVM" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlATEP" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlFondoSolidaridad" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlLicRemunerada" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlLicNoRemunerada" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlPrimasExtralegales" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlAnticipoCesantias" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlFondoEmpleado" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="nombreCampos" style="text-align: left">
                                                                            <asp:DropDownList ID="ddlAprendizSena" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="270px">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                </table>
