<%@ Page Language="C#" AutoEventWireup="true" Inherits="Facturacion_Padministracion_Departamentos" Codebehind="Departamentos.aspx.cs" %>
        ...
        <div class="principal">
            ...
            <table cellspacing="0" style="width: 1000px; border-top: silver thin solid; border-bottom: silver thin solid;" id="TABLE1" >
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:DropDownList ID="ddlCcosto" runat="server" AutoPostBack="True" data-placeholder="Seleccione una opción..." CssClass="chzn-select" OnSelectedIndexChanged="ddlCcosto_SelectedIndexChanged"
