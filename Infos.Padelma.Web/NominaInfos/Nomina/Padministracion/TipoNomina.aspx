<%@ Page Language="C#" AutoEventWireup="true" Inherits="Nomina_Paminidtracion_TipoNomina" Codebehind="TipoNomina.aspx.cs" %>
        ...
        <div class="principal">
            ...
            <table cellspacing="0" style="width: 1000px; border-top: silver thin solid; border-bottom: silver thin solid;" id="TABLE1">
                ...
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label6" runat="server" Text="Periocidad" Visible="False"></asp:Label></td>
                    <td class="Campos">
                        <asp:DropDownList ID="ddlPeriocidad" runat="server" Width="200px" data-placeholder="Seleccione una opción..."  CssClass="chzn-select" Visible="False">
                            <asp:ListItem Value="S">Semanal</asp:ListItem>
                            <asp:ListItem Value="D">Decanal</asp:ListItem>
                            <asp:ListItem Value="Q">Quincenal</asp:ListItem>
                            <asp:ListItem Value="M">Mesual</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td class="bordes"></td>
                </tr>
                    ...
                    <asp:GridView ID="gvLista" runat="server" Width="800px" GridLines="None" OnSelectedIndexChanged="gvLista_SelectedIndexChanged" CssClass="Grid" OnRowDeleting="gvLista_RowDeleting" AutoGenerateColumns="False" AllowPaging="True" PageSize="20" OnPageIndexChanging="gvLista_PageIndexChanging1">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="descripcion" HeaderText="Descripci&#243;n" ReadOnly="True"
                              ...
                              <asp:BoundField DataField="periocidad" HeaderText="Periodo" ReadOnly="True">
                                <HeaderStyle HorizontalAlign="Left" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" />
