<%@ Page Language="C#" AutoEventWireup="true" Inherits="Facturacion_Padministracion_DiasHabiles" Codebehind="DiasHabiles.aspx.cs" %>
        ...
        <div class="principal">
            ...
            <table cellspacing="0" style="width: 1000px; border-top: silver thin solid; border-bottom: silver thin solid;" id="TABLE1" >
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:DropDownList ID="ddlCcosto" runat="server" AutoPostBack="True" data-placeholder="Seleccione una opción..." CssClass="chzn-select"
                ...
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label1" runat="server" Text="De" Visible="False"></asp:Label></td>
                    <td class="Campos">
                        <asp:DropDownList ID="ddlDe" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select"
                            Visible="False" Width="100px">
                            <asp:ListItem Value="1">Lunes</asp:ListItem>
                            <asp:ListItem Value="2">Martes</asp:ListItem>
                            <asp:ListItem Value="3">Miercoes</asp:ListItem>
                ...
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label2" runat="server" Text="Hasta" Visible="False"></asp:Label></td>
                    <td class="Campos">
                        <asp:DropDownList ID="ddlHasta" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select"
                            Visible="False" Width="100px">
                            <asp:ListItem Value="1">Lunes</asp:ListItem>
                            <asp:ListItem Value="2">Martes</asp:ListItem>
                            <asp:ListItem Value="3">Miercoes</asp:ListItem>
                ...
                <div style="display: inline-block">
                    <asp:GridView ID="gvLista" runat="server" Width="600px" CssClass="Grid" GridLines="None" OnSelectedIndexChanged="gvLista_SelectedIndexChanged" OnRowDeleting="gvLista_RowDeleting" AutoGenerateColumns="False" AllowPaging="True" PageSize="20" OnPageIndexChanging="gvLista_PageIndexChanging">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="codCcosto" HeaderText="id Ccosto" ReadOnly="True">
                                <HeaderStyle HorizontalAlign="Left" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" />
                                <ItemStyle HorizontalAlign="Left" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" Width="70px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="desccosto" HeaderText="Ccosto" ReadOnly="True"
                            ...
                            <ItemStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" Width="1px" />
                            </asp:BoundField>
