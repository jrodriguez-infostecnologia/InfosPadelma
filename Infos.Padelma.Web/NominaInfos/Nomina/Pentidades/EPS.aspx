<%@ Page Language="C#" AutoEventWireup="true" Inherits="Nomina_Paminidtracion_EPS" Codebehind="EPS.aspx.cs" %>
        ...
        <div class="principal">
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <asp:ImageButton ID="nilbNuevo" runat="server" ImageUrl="~/Imagen/Bonotes/btnNuevo.jpg" ToolTip="Habilita el formulario para un nuevo registro" OnClick="lbNuevo_Click"
                            ...
                            onmouseover="this.src='../../Imagen/Bonotes/btnNuevN.jpg'" Height="21px" />
            ...
            <table cellspacing="0" style="width: 1000px; border-top: silver thin solid; border-bottom: silver thin solid;" id="TABLE1">
                ...
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label9" runat="server" Text="Empledo %" Visible="False"></asp:Label></td>
                    <td class="Campos">
                ...
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label10" runat="server" Text="Empleador %" Visible="False"></asp:Label></td>
                    <td class="Campos">
                ...
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label12" runat="server" Text="Cuenta" Visible="False"></asp:Label></td>
                    <td class="Campos">
