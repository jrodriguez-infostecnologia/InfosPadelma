<%@ Page Language="C#" AutoEventWireup="true" Inherits="Nomina_Paminidtracion_FondoPension" Codebehind="FondoPension.aspx.cs" %>
        ...
        <div class="principal">
            ...
            <table cellspacing="0" style="width: 1000px; border-top: silver thin solid; border-bottom: silver thin solid;" id="TABLE1">
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:DropDownList ID="ddlTercero" runat="server" Visible="False" Width="350px" data-placeholder="Seleccione una opción..." CssClass="chzn-select" AutoPostBack="True" OnSelectedIndexChanged="ddlTercero_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td class="bordes"></td>
                </tr>
                ...
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label8" runat="server" Text="Codigo Nacional" Visible="False"></asp:Label></td>
                    <td class="Campos">
                        <asp:DropDownList ID="ddlCodigoNacional" runat="server" Visible="False" Width="350px" data-placeholder="Seleccione una opción..." CssClass="chzn-select">
                        </asp:DropDownList>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label9" runat="server" Text="Emplado %" Visible="False"></asp:Label></td>
                    <td class="Campos">
                        <asp:TextBox ID="txvPempleado" runat="server" CssClass="input" onkeyup="formato_numero(this)" Visible="False"></asp:TextBox>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label10" runat="server" Text="Empleado %" Visible="False"></asp:Label></td>
                    <td class="Campos">
                        <asp:TextBox ID="txvPempleador" runat="server" CssClass="input" onkeyup="formato_numero(this)" Visible="False"></asp:TextBox>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label11" runat="server" Text="Inactividad %" Visible="False"></asp:Label></td>
                    <td class="Campos">
                        <asp:TextBox ID="txvPinactividad" runat="server" CssClass="input" onkeyup="formato_numero(this)" Visible="False"></asp:TextBox>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label12" runat="server" Text="Solidaridad %" Visible="False"></asp:Label></td>
                    <td class="Campos">
                        <asp:TextBox ID="txvPsolidario" runat="server" CssClass="input" onkeyup="formato_numero(this)" Visible="False"></asp:TextBox>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label13" runat="server" Text="Cuenta" Visible="False"></asp:Label></td>
                    <td class="Campos">
                        <asp:DropDownList ID="ddlCuenta" runat="server" Visible="False" Width="350px" data-placeholder="Seleccione una opción..." CssClass="chzn-select">
                        </asp:DropDownList>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label5" runat="server" Text="Observación" Visible="False"></asp:Label></td>
                    <td class="Campos">
                        <asp:TextBox ID="txtObservacion" runat="server" Visible="False" Width="350px" CssClass="input" Height="60px" TextMode="MultiLine"></asp:TextBox>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    ...
                    <td class="Campos">
                        <asp:CheckBox ID="chkIntegral" runat="server" Text="Integral" Visible="False" />
            ...
            <div style="text-align: center">
                <div style="display: inline-block">
                    <asp:GridView ID="gvLista" runat="server" Width="980px" GridLines="None" OnSelectedIndexChanged="gvLista_SelectedIndexChanged" CssClass="Grid" OnRowDeleting="gvLista_RowDeleting" AutoGenerateColumns="False" AllowPaging="True" PageSize="20" OnPageIndexChanging="gvLista_PageIndexChanging1">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="pEmpleado" HeaderText="Pempledo" ReadOnly="True">
                                <HeaderStyle HorizontalAlign="Left" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" />
                                <ItemStyle HorizontalAlign="Left" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" Width="40px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="pEmpleador" HeaderText="Pempleador" ReadOnly="True">
                                <HeaderStyle HorizontalAlign="Left" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" />
                                <ItemStyle HorizontalAlign="Left" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" Width="40px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="pInactividad" HeaderText="Pintac" ReadOnly="True">
                                <HeaderStyle HorizontalAlign="Left" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" />
                                <ItemStyle HorizontalAlign="Left" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" Width="40px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="pSolidaridad" HeaderText="Psolidario" ReadOnly="True">
                                <HeaderStyle HorizontalAlign="Left" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" />
                                <ItemStyle HorizontalAlign="Left" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" Width="40px" />
                            </asp:BoundField>
                            ...
                            <asp:CheckBoxField DataField="integral" HeaderText="Intg">
