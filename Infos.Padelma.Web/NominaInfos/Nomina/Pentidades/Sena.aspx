<%@ Page Language="C#" AutoEventWireup="true" Inherits="Nomina_Paminidtracion_SENA" Codebehind="Sena.aspx.cs" %>
        ...
        <div class="principal">
            ...
            <table cellspacing="0" style="width: 1000px; border-top: silver thin solid; border-bottom: silver thin solid;" id="TABLE1">
                ...
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label9" runat="server" Text="Porcentaje aplicar %" Visible="False"></asp:Label></td>
                    <td class="Campos">
                        <asp:TextBox ID="txvAporte" runat="server" CssClass="input" onkeyup="formato_numero(this)" Visible="False"></asp:TextBox>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label10" runat="server" Text="Pais" Visible="False"></asp:Label></td>
                    <td class="Campos">
                        <asp:DropDownList ID="ddlPais" runat="server" Visible="False" Width="350px" data-placeholder="Seleccione una opción..."  CssClass="chzn-select" AutoPostBack="True" OnSelectedIndexChanged="ddlPais_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label11" runat="server" Text="Ciudad" Visible="False"></asp:Label></td>
                    <td class="Campos">
                        <asp:DropDownList ID="ddlCiudad" runat="server" Visible="False" Width="350px" data-placeholder="Seleccione una opción..."  CssClass="chzn-select">
                        </asp:DropDownList>
                    </td>
                    <td class="bordes"></td>
                </tr>
                    ...
                    <asp:GridView ID="gvLista" runat="server" Width="980px" GridLines="None" OnSelectedIndexChanged="gvLista_SelectedIndexChanged" CssClass="Grid" OnRowDeleting="gvLista_RowDeleting" AutoGenerateColumns="False" AllowPaging="True" PageSize="20" OnPageIndexChanging="gvLista_PageIndexChanging1">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="descripcion" HeaderText="Descripci&#243;n" ReadOnly="True"
                              ...
                              <asp:BoundField DataField="pAporte" HeaderText="pAporte" ReadOnly="True">
                                <HeaderStyle HorizontalAlign="Left" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" />
                                <ItemStyle HorizontalAlign="Left" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" Width="40px" />
                            </asp:BoundField>
