                ...
                <table style="width: 100%; height: 700px;" cellspacing="0">
                    <tr>
                        <td style="vertical-align: top; width: 100%; text-align: left; height: 700px;">
                            ...
                            <CR:CrystalReportViewer ID="crViewer" runat="server" AutoDataBind="true" DisplayStatusbar="False" EnableDatabaseLogonPrompt="False" EnableDrillDown="False" EnableParameterPrompt="False" EnableTheming="False" ToolPanelView="None" Width="350px" PrintMode="ActiveX" />
