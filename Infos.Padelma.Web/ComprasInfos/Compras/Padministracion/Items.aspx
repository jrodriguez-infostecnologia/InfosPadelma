                ...
                <ContentTemplate>
                    <div style="padding: 3px 10px 3px 10px">
                        <div style="border: 1px solid silver; display: inline-block;">
                            ...
                            <table id="TABLE1" cellspacing="0" style="width: 950px; border-top: silver thin solid; border-bottom: silver thin solid; border: thin none silver;">
                                <tr>
                                ...
                                <tr>
                                    <td style="text-align: left; width: 170px">
                                        <asp:Label ID="Label8" runat="server" Text="Papeleta" Visible="False"></asp:Label>
                                    </td>
                                    <td style="text-align: left">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <asp:RadioButtonList ID="rblTipo" runat="server" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" RepeatColumns="6" RepeatDirection="Horizontal" Style="font-size: 12px" Visible="False" Width="600px">
