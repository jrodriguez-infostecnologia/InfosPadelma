            ...
            <ul id="nav">
                <li class="" style="text-align: left"><a class="" href="#">Administración</a>
                    <ul class="submenu">
                        ...
                        <li class="" style="text-align: left"><a class="" href="#">Plan de Cuentas</a>
                            <ul class="subsubmenu">
                                <li><a href="#" onclick="addTab('PlanPuc','Padministracion/PlanCuenta.aspx',true);">Plan</a></li>
                                <li><a href="#" onclick="addTab('Puc','Padministracion/Puc.aspx',true);">Cuentas</a></li>
                            </ul>
                        </li>

                        <li><a href="#" onclick="addTab('CCosto','Padministracion/CentroCosto.aspx',true);">Centro de Costo</a></li>
                        <li class="" style="text-align: left"><a class="" href="#">Tercero/Cliente/Proveedor</a>
                            <ul class="subsubmenu">
                                <li><a href="#" onclick="addTab('Terceros','Padministracion/Terceros.aspx',true);">Terceros</a></li>
                                <li><a href="#" onclick="addTab('Proveedores','Padministracion/Proveedor.aspx',true);">Proveedores</a></li>
                                <li><a href="#" onclick="addTab('Clientes','Padministracion/Clientes.aspx',true);">Clientes</a></li>
                            </ul>
                        </li>
                        <li class="" style="text-align: left"><a class="" href="#">Impuestos</a>
                            <ul class="subsubmenu">
                                ...
                                <li><a href="#" onclick="addTab('LlavesIR','Padministracion/LlavesIR.aspx',true);">LLaves Impuesto/Retención</a></li>
                                <li><a href="#" onclick="addTab('ConfigIR','Padministracion/ConfigIR.aspx',true);">Config. Impuesto/Retención</a></li>
