<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Clientes.aspx.cs" Inherits="Facturacion_Padministracion_Clientes1" %>
        ...
        <div style="vertical-align: top; width: 1000px; height: 600px; text-align: center; font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; font-size: 12px; color: #003366;">
            ...
            <table cellspacing="0" style="width: 1000px; border-top: silver thin solid; border-bottom: silver thin solid;" id="TABLE1">
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:DropDownList ID="ddlCiudad" runat="server" Width="300px" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Visible="False" Height="20px">
                        </asp:DropDownList>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    ...
                    <td class="Campos">
                        <asp:TextBox ID="txtDireccion" runat="server" Visible="False" Width="100%" CssClass="input"></asp:TextBox></td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    <td class="bordes"></td>
                    ...
                    <td class="Campos">
                        <asp:TextBox ID="txtTelefono" runat="server" Visible="False" Width="100px" CssClass="input" MaxLength="12"></asp:TextBox>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    ...
                    <td class="Campos">
                        <asp:TextBox ID="txtEmail" runat="server" Visible="False" Width="250px" CssClass="input"></asp:TextBox>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    ...
                    <td colspan="4">
                        <div style="text-align:center">
                            <div style="display:inline-block">
                                <asp:GridView ID="gvClaseIR" runat="server" AutoGenerateColumns="False" CssClass="Grid" Width="700px" Visible="False" OnRowUpdating="gvClaseIR_RowUpdating">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Valor">
                                            <ItemTemplate>
                                                <asp:DropDownList ID="ddlConcepto" runat="server" Width="180px" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Enabled="False" AutoPostBack="True" OnSelectedIndexChanged="ddlConcepto_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="llave">
                                            <ItemTemplate>
                                                <asp:DropDownList ID="ddlLlave" runat="server" Width="250px" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Enabled="False">
                                                </asp:DropDownList>
                                            </ItemTemplate>
