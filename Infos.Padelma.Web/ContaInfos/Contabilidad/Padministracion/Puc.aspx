        ...
        <div class="principal">
            ...
            <table style="border-top: silver thin solid; border-bottom: silver thin solid; width: 950px;" cellspacing="0">
                ...
                <tr>
                    ...
                    <td style="width: 300px; text-align: left">
                        <asp:TextBox ID="txtNivel" runat="server" Visible="False" Width="50px" CssClass="input" onkeyup="formato_numero(this)"></asp:TextBox>
                    </td>
                    <td style="width: 20px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="width: 120px; text-align: left">
                        <asp:CheckBox
                            ID="chkCcosto" runat="server" Text="Centro costo" Visible="False" AutoPostBack="True" OnCheckedChanged="chkCcosto_CheckedChanged" />
                    </td>
                    <td style="width: 300px; text-align: left">
                ...
                <tr>
                    ...
                    <td style="text-align: left" class="auto-style2">
                        <asp:CheckBox ID="chkTercero" runat="server" Text="Maneja tercero" Visible="False" AutoPostBack="True" OnCheckedChanged="chkTercero_CheckedChanged" />
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="4" style="text-align: left">
                        <asp:Panel ID="upImpuesto" runat="server" Visible="False">
                                ...
                                <div style="display: inline-block; text-align: left; width: 870px; height: 100%">
                                    <div style="padding: 5px; float: left; display: inline-block">
                                        <div style="border: 1px solid silver; padding: 5px; float: left">
                                            <asp:CheckBox ID="chkImpuesto" runat="server" Text="Impuestos" Visible="False" AutoPostBack="True" OnCheckedChanged="chkImpuesto_CheckedChanged" />
                                            <div>
                                                <table cellpadding="0" cellspacing="0" style="width: 400px">
                                                    <tr>
                                                        ...
                                                        <td style="width: 280px; text-align: left;" width="310px">
                                                            <asp:DropDownList ID="ddlTipoIR" runat="server" CssClass="chzn-select" data-placeholder="Seleccione una opción..." Width="200px" AutoPostBack="True" OnSelectedIndexChanged="ddlTipoIR_SelectedIndexChanged" Visible="False">
                                                        ...
                                                        <td style="width: 70px; text-align: left">
                                                            <asp:TextBox ID="txvTasaIR" runat="server" CssClass="input" Font-Bold="True" onkeyup="formato_numero(this)" ToolTip="Formato fecha (dd/mm/yyyy)" Width="50px" Visible="False">0</asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 80px">
                                                        ...
                                                        <td style="width: 280px; text-align: left;" width="310px">
                                                            <asp:DropDownList ID="ddlCalseIR" runat="server" CssClass="chzn-select" data-placeholder="Seleccione una opción..." Width="200px" Visible="False">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td style="width: 5px; text-align: left"></td>
                                                        <td style="width: 120px; text-align: left">
                                                        ...
                                                        <td style="width: 70px; text-align: left">
                                                            <asp:TextBox ID="txvBaseIR" runat="server" CssClass="input" Font-Bold="True" onkeyup="formato_numero(this)" ToolTip="Formato fecha (dd/mm/yyyy)" Width="80px" Visible="False">0</asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
