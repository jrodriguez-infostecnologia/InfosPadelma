                                        ...
                                        <table cellpadding="0" cellspacing="0" class="auto-style1">
                                            <tr>
                                                ...
                                                <td style="text-align: left">
                                                    <asp:DropDownList ID="niddlAno" runat="server" Visible="False" Width="150px" CssClass="chzn-select" data-placeholder="Seleccione una opción...">
                                                    </asp:DropDownList>
                                                </td>
                                                <td style="text-align: left">
            ...
            <table cellspacing="0" style="width: 1000px; border-top: silver thin solid; border-bottom: silver thin solid;" id="TABLE1">
                ...
                <tr>
                    ...
                    <td style="width: 180px; text-align: left">
                        <asp:TextBox ID="txvAño" runat="server" Visible="False" Width="150px" AutoPostBack="True" OnTextChanged="txtConcepto_TextChanged" CssClass="input" onkeyup="formato_numero(this)" MaxLength="6"></asp:TextBox></td>
                    <td style="width: 100px; text-align: left">
                        <asp:Label ID="Label2" runat="server" Text="Mes" Visible="False"></asp:Label></td>
                    <td style="width: 180px; text-align: left">
                        <asp:DropDownList ID="ddlMes" runat="server" CssClass="input" Visible="False" Width="150px" AutoPostBack="True" OnSelectedIndexChanged="ddlMes_SelectedIndexChanged">
                ...
                <tr>
                    ...
                    <td style="width: 180px; text-align: left">
                        ...
                        <asp:TextBox ID="txtFechaIni" runat="server" class="input" Font-Bold="True" ReadOnly="True" ToolTip="Formato fecha (dd/mm/yyyy)" Visible="False" Width="150px" placeholder="dd/mm/aaaa" OnTextChanged="txtFechaIni_TextChanged" AutoPostBack="True"></asp:TextBox>
                    </td>
                    <td style="width: 100px; text-align: left">
                    ...
                    <td style="width: 180px; text-align: left">
                        ...
                        <asp:TextBox ID="txtFechaFinal" runat="server" class="input" Font-Bold="True" ReadOnly="True" ToolTip="Formato fecha (dd/mm/yyyy)" placeholder="dd/mm/aaaa" Visible="False" Width="150px" OnTextChanged="txtFechaFinal_TextChanged" AutoPostBack="True"></asp:TextBox>
                    </td>
                    <td style="width: 250px"></td>
                </tr>
                <tr>
