        ...
        <div style="vertical-align: top; width: 1000px; height: 600px; text-align: center; font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; font-size: 12px; color: #003366;">
            ...
            <table cellspacing="0" style="width: 1000px; border-top: silver thin solid; border-bottom: silver thin solid;" id="TABLE1">
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:DropDownList ID="ddlTercero" runat="server" Visible="False" Width="350px" AutoPostBack="True" data-placeholder="Seleccione una opción..." CssClass="chzn-select">
                        </asp:DropDownList></td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    ...
                    <td class="Campos">
                        <asp:TextBox ID="txtCodigo" runat="server" AutoPostBack="True" OnTextChanged="txtCodigo_TextChanged"
                            Visible="False" Width="100px" CssClass="input"></asp:TextBox></td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    <td class="bordes"></td>
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:DropDownList ID="ddlClaseProveedor" runat="server" Visible="False" Width="350px" data-placeholder="Seleccione una opción..." CssClass="chzn-select">
                        </asp:DropDownList></td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:DropDownList ID="ddlCiudad" runat="server" Width="350px" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Visible="False" Height="20px" TabIndex="14">
                        </asp:DropDownList>
                    </td>
                    <td class="bordes"></td>
                </tr>
