...
$(function(){
var d=$("<div style=\"position:absolute;top:-950px;width:100px;height:100px;padding:5px\"></div>").appendTo("body");
...
$("<a href=\"javascript:contadorMenos();  \" class=\"tabs-close\"></a>").appendTo(tab);
}else{
...
$.fn.tabs.defaults={width:"auto",height:"auto",headerWidth:150,tabWidth:"auto",tabHeight:20,selected:0,showHeader:true,plain:false,fit:false,border:true,tools:null,toolPosition:"right",tabPosition:"top",scrollIncrement:100,scrollDuration:400,onLoad:function(_369){
