...
public class Cbascula
{
    ...
    public DataView GetBasculaTiquete(string tiquete, int empresa)
    {
        ...
        return Cacceso.DataSetParametros("spSeleccionaBregistroBasculaTiquete", iParametros, objValores, "ppa").Tables[0].DefaultView;
    }
    ...
    public int AnulaCreaTiquete(string tiquete, string tipoTiquete, string tipoTrans, DateTime fechaProceso, decimal pesoBruto,
        ...
        decimal sacos, decimal pesoSacos, string sellos, string funcionario, out string tiqueteNuevo, int empresa, 
        decimal pesoDescuento, string codigoConductor, string nombreConductor, string remisionPlanta, string remisionComercializadora, bool anulaTiquete, string tipoRemision, string observacion)
    {
        ...
        string[] iParametros = new string[]{ "@tiquete", "@tipoTiquete", "@tipoTrans", "@fechaProceso", "@pesoBruto", "@pesoTara","@pesoDes",
            "@vehiculo", "@remolque", "@producto", "@procedencia", "@finca", "@racimos", "@sacos", "@pesoSacos", "@sellos", "@funcionario" ,"@empresa","@codigoConductor","@nombreConductor","@remisionPlanta","@remisionComercializadora","@anulaTiquete","@tipoRemision","@observacion"};
        ...
        object[] objValores = new object[] { tiquete, tipoTiquete, tipoTrans, fechaProceso, pesoBruto, pesoTara,pesoDescuento, vehiculo, remolque, producto,
            procedencia, finca, racimos, sacos, pesoSacos, sellos, funcionario, empresa , codigoConductor, nombreConductor, remisionPlanta, remisionComercializadora, anulaTiquete,tipoRemision, observacion };

        objRetorno = Cacceso.ExecProc("spAnulaModificaTiquete", iParametros, oParametros, objValores, "ppa");
    ...
    public int ModificaTiquete(string tiquete, DateTime fechaProceso, decimal pesoBruto, decimal pesoTara, string vehiculo, string remolque,
        ...
        string codigoConductor, string nombreConductor, string observacion, string cliente, string tercero)
    {
        object[] objRetorno = new object[2];
        string[] iParametros = new string[]{ "@tiquete", "@fechaProceso", "@pesoBruto", "@pesoTara", "@vehiculo", "@remolque", "@producto", 
            ...
            "@codigoConductor","@nombreConductor","@observacion","@cliente","@tercero"};
        string[] oParametros = new string[] { "@retorno" };
        object[] objValores = new object[] { tiquete, fechaProceso, pesoBruto, pesoTara, vehiculo, remolque, producto,
            procedencia, finca, racimos, sacos, pesoSacos, sellos,bodega,cooperativa , empresa, pesoDes, codigoConductor, nombreConductor, observacion, cliente, tercero};
    ...
    public void SeleccionaRemisionesTiquete(int empresa, string tipo, string tiquete, out string remisionPlanta, out string remisionComer)
    {
        ...
        remisionPlanta =  Convert.ToString(Cacceso.ExecProc(
        ...
        remisionComer = Convert.ToString(Cacceso.ExecProc(
           "spSeleccionaRemisionesTiquete",
           iParametros,
           oParametros,
           objValores,
