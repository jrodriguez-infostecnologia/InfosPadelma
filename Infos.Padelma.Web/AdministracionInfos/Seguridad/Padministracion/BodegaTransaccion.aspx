<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BodegaTransaccion.aspx.cs" Inherits="Agronomico_Poperaciones_BodegaTransaccion" %>
    ...
    <form id="form1" runat="server">
        <div class="principal">
                ...
                <tr>
                    ...
                    <td colspan="4" style="text-align: center">
                        <div style="display: inline-block">
                            ...
                            <select runat="server" id="selBodega" class="multiselect" multiple="true" name="countries[]" visible="False">
                            </select>
                        </div>
                    </td>
                </tr>
            ...
            <div class="tablaGrilla">
                <div style="display: inline-block">
                    <asp:GridView ID="gvLista" runat="server" Width="400px" GridLines="None" CssClass="Grid" OnSelectedIndexChanged="gvLista_SelectedIndexChanged" OnRowDeleting="gvLista_RowDeleting" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanging="gvLista_PageIndexChanging" PageSize="20">
