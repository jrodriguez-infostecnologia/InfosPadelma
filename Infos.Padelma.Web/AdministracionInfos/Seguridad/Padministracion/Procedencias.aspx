        ...
        <div class="principal">
            ...
            <table cellspacing="0" style="width: 950px; border-top: silver thin solid; border-bottom: silver thin solid;" id="TABLE1">
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:TextBox ID="txtId" runat="server" Visible="False" Width="150px" AutoPostBack="True" OnTextChanged="txtConcepto_TextChanged" CssClass="input" ReadOnly="True"></asp:TextBox></td>
                    <td class="bordes">&nbsp;</td>
                </tr>
                <tr>
                    <td class="bordes"></td>
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:TextBox ID="txtCorreos" runat="server" Visible="False" Width="350px" AutoPostBack="True" OnTextChanged="txtConcepto_TextChanged" CssClass="input" Height="80px" TextMode="MultiLine" ToolTip="Puede ingresar varios correos separados por punto y coma (;)"></asp:TextBox>
                    </td>
                    <td class="bordes">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <asp:GridView ID="gvLista" runat="server" Width="950px" GridLines="None" OnSelectedIndexChanged="gvLista_SelectedIndexChanged1" OnRowDeleting="gvLista_RowDeleting" AutoGenerateColumns="False" CssClass="Grid" AllowPaging="True" OnPageIndexChanging="gvLista_PageIndexChanging" PageSize="20">
                        ...
                        <asp:TemplateField HeaderText="Elim">
                            ...
                            <asp:BoundField DataField="DesAgrupado" HeaderText="AgrupadoPor">
                             ...
                             <asp:BoundField DataField="extractora" HeaderText="idExtractora">
                             <ItemStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" Width="50px" />
                             </asp:BoundField>
