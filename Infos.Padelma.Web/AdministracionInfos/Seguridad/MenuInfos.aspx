            ...
            <ul id="nav">
                    ...
                    <ul class="submenu">
                        <li class="" style="text-align: left"><a class="" href="#">Parametros</a>
                            <ul class="subsubmenu">
                                ...
                                <li><a href="#" onclick="addTab('Parametros General','Padministracion/ParametrosGeneral.aspx',true)">Parametros Generales </a></li>
                            </ul>
                        </li>

                        <li class="" style="text-align: left"><a class="" href="#">Certificaciones</a>
                            <ul class="subsubmenu">
                                <li><a href="#" onclick="addTab('Certificados RSPO','Padministracion/CertificadosRSPO.aspx',true)">Grupo de Certificado</a></li>
                                <li><a href="#" onclick="addTab('Detalle Cer.','Padministracion/CertificadoDetalle.aspx',true)">Asignar Certificaciones</a></li>
                            </ul>
                        </li>
                        <li class="" style="text-align: left"><a class="" href="#">Tipo de Transacción</a>
                            <ul class="subsubmenu">
                                ...
                                <li><a href="#" onclick="addTab('Trn. Producto','Poperaciones/ProductoTransaccion.aspx',true)">Trn. Producto</a></li>
                ...
                <li class="" style="text-align: left"><a class="" href="#">Operaciones</a>
                    <ul class="submenu">
                        ...
                        <li><a href="#" onclick="window.open('Poperaciones/Tiquetes.aspx');">Tiquetes Bascula</a></li>
                        <li><a href="#" onclick="addTab('Tiq Incompletos','Poperaciones/CompletarTiquetes.aspx',true)">Tiquetes Incompletos</a></li>
                        <li><a href="#" onclick="addTab('Salidas Port','Poperaciones/Salidas.aspx',true)">Salidas Portería</a></li>
                    </ul>
                </li>
