<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Vehiculos.aspx.cs" Inherits="Administracion_Poperacion_Vehiculos" %>
        ...
        <div class="principal">
            ...
            <table cellspacing="0" style="width: 1000px; border-top: silver thin solid; border-bottom: silver thin solid;" id="TABLE1">
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:DropDownList ID="ddlTipoVehiculo" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Width="350px" Visible="False" AutoPostBack="True" OnSelectedIndexChanged="ddlFinca_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td class="bordes"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:TextBox ID="txvPesoTara" runat="server" CssClass="input" Visible="False" Width="150px" onkeyup="formato_numero(this)">0</asp:TextBox>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
                    ...
                    <td class="Campos">
                        ...
                        <asp:CheckBox ID="chkAutomatico" runat="server" Text="Detare automatico" Visible="False" />
                    </td>
                    <td class="bordes"></td>
                </tr>
            </table>
                ...
                <asp:GridView ID="gvLista" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="Grid" OnRowDeleting="gvLista_RowDeleting" PageSize="20" Width="800px" OnPageIndexChanging="gvLista_PageIndexChanging" OnSelectedIndexChanged="gvLista_SelectedIndexChanged1">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="pesoTara" HeaderText="PesoTara">
                            <HeaderStyle HorizontalAlign="Center" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" Width="150px" />
                            <ItemStyle HorizontalAlign="Left" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="tipo" HeaderText="TipoVehículo">
                            <HeaderStyle HorizontalAlign="Center" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" Width="80px" />
                            <ItemStyle HorizontalAlign="Left" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" />
                        </asp:BoundField>
