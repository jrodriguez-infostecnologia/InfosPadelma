    ...
    <form id="form1" runat="server">
        <div class="principal">
            ...
            <table id="TABLE1" cellspacing="0" style="BORDER-TOP: silver thin solid; WIDTH: 1000px; BORDER-BOTTOM: silver thin solid">
                            ...
                            <tr>
                                ...
                                <td style="VERTICAL-ALIGN: top; WIDTH: 140px; TEXT-ALIGN: left">
                                    <asp:DropDownList ID="ddlOperación" runat="server" AutoPostBack="True" data-placeholder="Seleccione una opción..." CssClass="chzn-select" OnSelectedIndexChanged="ddlOperación_SelectedIndexChanged" Visible="False" Width="250px">
                                        ...
                                        <asp:ListItem Value="3">Anula y crea nuevo despacho</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td></td>
                            </tr>
                ...
                <tr>
                    <td style="vertical-align: top; background-color: transparent; text-align: left;" colspan="2">
                        <asp:RadioButtonList ID="rblTipoImpresion" runat="server" RepeatDirection="Horizontal" Visible="False" Width="100%">
                            <asp:ListItem Value="RINV">Remisión Inversora</asp:ListItem>
                            <asp:ListItem Value="RPAD">Remisión Padelma</asp:ListItem>
                            <asp:ListItem Selected="True" Value="REMO">Remisión Otros</asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                    <td style="VERTICAL-ALIGN: top; WIDTH: 200px; BACKGROUND-COLOR: transparent; TEXT-ALIGN: left">
                        <asp:Label ID="lblRemisionComercializadora" runat="server" Text="Remisión Planta" Visible="False"></asp:Label>
                    </td>
                    <td style="VERTICAL-ALIGN: top; WIDTH: 360px; BACKGROUND-COLOR: transparent; TEXT-ALIGN: left">
                        <asp:TextBox ID="txtRemisionComer" runat="server" CssClass="input" Visible="False" Width="300px"></asp:TextBox>
                        <asp:ImageButton ID="btnRemisiones" runat="server" ImageUrl="~/Imagen/TabsIcon/reload.png" OnClick="btnRemisiones_Click" Visible="False" />
                    </td>
                </tr>
                <tr>
                    <td style="WIDTH: 200px; vertical-align: top; background-color: transparent; text-align: left;">
                    ...
                    <td style="VERTICAL-ALIGN: top; WIDTH: 360px; BACKGROUND-COLOR: transparent; TEXT-ALIGN: left">
                        <asp:TextBox ID="txvPesoBruto" runat="server" CssClass="input" Visible="False" Width="150px"  AutoPostBack="True" OnTextChanged="txvPesoBruto_TextChanged" TextMode="Number"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="WIDTH: 200px; vertical-align: top; background-color: transparent; text-align: left;">
                    ...
                    <td style="VERTICAL-ALIGN: top; WIDTH: 140px; TEXT-ALIGN: left">
                        <asp:TextBox ID="txvPesoTara" runat="server" CssClass="input" Visible="False" Width="150px" AutoPostBack="True" OnTextChanged="txvPesoTara_TextChanged" TextMode="Number"></asp:TextBox>
                    </td>
                    <td style="VERTICAL-ALIGN: top; WIDTH: 200px; BACKGROUND-COLOR: transparent; TEXT-ALIGN: left">
                        <asp:Label ID="Label16" runat="server" Text="Peso Descuento Kg" Visible="False"></asp:Label>
                    </td>
                    <td style="VERTICAL-ALIGN: top; WIDTH: 360px; BACKGROUND-COLOR: transparent; TEXT-ALIGN: left">
                        <asp:TextBox ID="txvPesoDescuento" runat="server" CssClass="input" Visible="False" Width="150px" AutoPostBack="True" OnTextChanged="txvPesoDescuento_TextChanged" TextMode="Number"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="WIDTH: 200px; vertical-align: top; background-color: transparent; text-align: left;">
                    ...
                    <td style="VERTICAL-ALIGN: top; WIDTH: 140px; TEXT-ALIGN: left">
                        <asp:TextBox ID="txvPneto" runat="server" CssClass="input" onkeyup="formato_numero(this)" Visible="False" Width="150px" Enabled="False" TextMode="Number">0</asp:TextBox>
                    </td>
                    <td style="VERTICAL-ALIGN: top; WIDTH: 200px; BACKGROUND-COLOR: transparent; TEXT-ALIGN: left">
                        </td>
                    <td style="VERTICAL-ALIGN: top; WIDTH: 360px; BACKGROUND-COLOR: transparent; TEXT-ALIGN: left">
                ...
                <tr>
                    ...
                    <td style="VERTICAL-ALIGN: top; WIDTH: 360px; BACKGROUND-COLOR: transparent; TEXT-ALIGN: left">
                        <asp:TextBox ID="txvRacimos" runat="server" CssClass="input" Visible="False" Width="150px" ></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="WIDTH: 200px; vertical-align: top; background-color: transparent; text-align: left;">
                        <asp:Label ID="lblSacos" runat="server" Text="Sacos" Visible="False"></asp:Label>
                    </td>
                    <td style="WIDTH: 140px; TEXT-ALIGN: left">
                        <asp:TextBox ID="txvSacos" runat="server" CssClass="input" Visible="False" Width="150px" ></asp:TextBox>
                    </td>
                    <td style="VERTICAL-ALIGN: top; WIDTH: 200px; BACKGROUND-COLOR: transparent; TEXT-ALIGN: left">
                        <asp:Label ID="lblPesoSacos" runat="server" Text="Peso Sacos Kg." Visible="False"></asp:Label>
                    </td>
                    <td style="VERTICAL-ALIGN: top; WIDTH: 360px; BACKGROUND-COLOR: transparent; TEXT-ALIGN: left">
                        <asp:TextBox ID="txvPesoSacos" runat="server" CssClass="input" Visible="False" Width="150px" ></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="WIDTH: 200px; vertical-align: top; background-color: transparent; text-align: left;">
                    ...
                    <td style="VERTICAL-ALIGN: top; WIDTH: 200px; BACKGROUND-COLOR: transparent; TEXT-ALIGN: left">
                        <asp:Label ID="Label14" runat="server" Text="Tipo tiquete" Visible="False"></asp:Label>
                    </td>
                    <td style="VERTICAL-ALIGN: top; WIDTH: 360px; BACKGROUND-COLOR: transparent; TEXT-ALIGN: left">
                        <asp:DropDownList ID="ddlTiquete" runat="server" AutoPostBack="True" data-placeholder="Seleccione una opción..." CssClass="chzn-select" OnSelectedIndexChanged="ddlProducto_SelectedIndexChanged" Visible="False" Width="250px">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td style="WIDTH: 200px; vertical-align: top; background-color: transparent; text-align: left;">
                        <asp:Label ID="Label17" runat="server" Text="Tercero" Visible="False"></asp:Label>
                    </td>
                    <td style="WIDTH: 140px; TEXT-ALIGN: left">
                        <asp:DropDownList ID="ddlTercero" runat="server" AutoPostBack="True" data-placeholder="Seleccione una opción..." CssClass="chzn-select" OnSelectedIndexChanged="ddlTercero_SelectedIndexChanged" Visible="False" Width="350px">
                        </asp:DropDownList>
                    </td>
                    <td style="VERTICAL-ALIGN: top; WIDTH: 200px; BACKGROUND-COLOR: transparent; TEXT-ALIGN: left">
                        <asp:Label ID="Label18" runat="server" Text="Cliente" Visible="False"></asp:Label>
                    </td>
                    <td style="VERTICAL-ALIGN: top; WIDTH: 360px; BACKGROUND-COLOR: transparent; TEXT-ALIGN: left">
                        <asp:DropDownList ID="ddlCliente" runat="server" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Visible="False" Width="250px">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td style="WIDTH: 200px; vertical-align: top; background-color: transparent; text-align: left;">
                        <asp:Label ID="lblBodega" runat="server" Text="Bodega Descargue" Visible="False"></asp:Label>
                    </td>
                    <td style="WIDTH: 140px; TEXT-ALIGN: left">
                    ...
                    <td style="VERTICAL-ALIGN: top; WIDTH: 360px; BACKGROUND-COLOR: transparent; TEXT-ALIGN: left">
                        <asp:RadioButtonList ID="rblDescargador" runat="server" RepeatDirection="Horizontal">
                ...
                <tr>
                    <td style="WIDTH: 200px; vertical-align: top; background-color: transparent; text-align: left;">
                        <asp:Label ID="Label15" runat="server" Text="Observación" Visible="False"></asp:Label>
                    </td>
                    <td style="TEXT-ALIGN: left" colspan="3">
                        <asp:TextBox ID="txtObservacion" runat="server" CssClass="input" Visible="False" Width="100%" Height="60px" TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
