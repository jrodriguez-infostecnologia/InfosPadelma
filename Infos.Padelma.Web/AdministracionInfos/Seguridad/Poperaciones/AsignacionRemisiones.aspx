...
<body>
    <form id="form1" runat="server">
        <div class="principal" >
            ...
            <table id="TABLE1" cellspacing="0" onclick="return TABLE1_onclick()" style="BORDER-TOP: silver thin solid; WIDTH: 1000px; BORDER-BOTTOM: silver thin solid">
                <tr>
                    <td colspan="4">
                ...
                <tr>
                    ...
                    <td style="WIDTH: 220px; BACKGROUND-COLOR: transparent; TEXT-ALIGN: left">
                        <asp:Label ID="Label2" runat="server" Text="Persona que Recibe" Visible="False"></asp:Label>
                    </td>
                    <td style="VERTICAL-ALIGN: top; WIDTH: 300px; BACKGROUND-COLOR: transparent; TEXT-ALIGN: left">
                        <asp:DropDownList ID="ddlOperadorLogistico" runat="server" AutoPostBack="True" CssClass="chzn-select" data-placeholder="Seleccione una opción..." Visible="False" Width="350px">
                        </asp:DropDownList>
                    </td>
                    <td style="WIDTH: 250px"></td>
                </tr>
