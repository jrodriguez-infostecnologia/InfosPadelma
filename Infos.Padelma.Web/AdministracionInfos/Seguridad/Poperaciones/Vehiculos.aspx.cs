...
public partial class Administracion_Poperacion_Vehiculos : System.Web.UI.Page
{
    ...
    private void EntidadKey()
    {
        ...
        try
        {
            if (CentidadMetodos.EntidadGetKey("bVehiculo", "ppa", objKey).Tables[0].Rows.Count > 0)
            {
    ...
    private void Guardar()
    {
        ...
        try
        {
            ...
            switch (CentidadMetodos.EntidadInsertUpdateDelete("bVehiculo", operacion, "ppa", objValores))
            {
                case 0:
    ...
    protected void gvLista_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            switch (CentidadMetodos.EntidadInsertUpdateDelete("bVehiculo", "elimina", "ppa", objValores))
            {
                case 0:
    ...
    protected void gvLista_SelectedIndexChanged1(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (this.gvLista.SelectedRow.Cells[4].Text != "&nbsp;")
                this.txvPesoTara.Text = Server.HtmlDecode(this.gvLista.SelectedRow.Cells[4].Text);
            else
                this.txvPesoTara.Text = "0";
