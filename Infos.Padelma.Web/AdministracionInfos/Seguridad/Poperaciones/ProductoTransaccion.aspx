<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductoTransaccion.aspx.cs" Inherits="Agronomico_Poperaciones_ProductoTransaccion" %>
        ...
        <div class="principal">
            ...
            <table cellspacing="0" style="width: 100%; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: silver;" id="Table2">
                ...
                <tr>
                    ...
                    <td style="text-align: left">
                        <asp:DropDownList ID="ddlTipoTransaccion" runat="server" CssClass="chzn-select" data-placeholder="Seleccione una opción..." Width="350px" Visible="False">
                        </asp:DropDownList>
                    </td>
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:DropDownList ID="ddlProducto" runat="server" CssClass="chzn-select" data-placeholder="Seleccione una opción..." Width="350px" Visible="False">
                        </asp:DropDownList>
                    </td>
                    <td class="bordes">&nbsp;</td>
                </tr>
                <tr>
                    <td class="bordes">&nbsp;</td>
                    <td class="nombreCampos">
                        <asp:Label ID="Label9" runat="server" Text="Remisión" Visible="False"></asp:Label>
                    </td>
                    <td class="Campos">
                        <asp:DropDownList ID="ddlRemision" runat="server" CssClass="chzn-select" data-placeholder="Seleccione una opción..." Width="350px" Visible="False">
                        </asp:DropDownList>
                    </td>
                    <td class="bordes">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td class="nombreCampos">
                        &nbsp;</td>
                    <td class="Campos">
                        <asp:CheckBox ID="chkRemisionComercializadora" runat="server" Text="Remisión Comercializadora" Visible="False" />
                    </td>
                    <td class="bordes">&nbsp;</td>
                </tr>
                <tr>
            ...
            <div style="text-align:center">
                <div style="display: inline-block">
                    <asp:GridView ID="gvLista" runat="server" Width="900px" GridLines="None" CssClass="Grid" OnSelectedIndexChanged="gvLista_SelectedIndexChanged" OnRowDeleting="gvLista_RowDeleting" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanging="gvLista_PageIndexChanging" PageSize="20">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="remision" HeaderText="Remisión" ReadOnly="True">
                                <HeaderStyle HorizontalAlign="Left" BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" />
