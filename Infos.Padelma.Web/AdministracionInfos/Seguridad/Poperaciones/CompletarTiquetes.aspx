        ...
        <div class="principal">
            ...
            <table id="TABLE1" cellspacing="0" style="BORDER-TOP: silver thin solid; WIDTH: 1000px; BORDER-BOTTOM: silver thin solid">
                ...
                <tr>
                    ...
                    <td style="VERTICAL-ALIGN: top; WIDTH: 140px; TEXT-ALIGN: left">
                        <asp:DropDownList ID="ddlTipoTransaccion" runat="server" AutoPostBack="True" data-placeholder="Seleccione una opción..." CssClass="chzn-select" Visible="False" Width="250px">
                        </asp:DropDownList>
                    </td>
