...
SELECT        a.empresa, SUBSTRING(CONVERT(varchar, CONVERT(money, RTRIM(tt.codigo)), 1), 1, LEN(CONVERT(varchar, CONVERT(money, RTRIM(tt.codigo)), 1)) - 3) AS identificacion, b.tercero AS codTercero, 
                         tt.razonSocial AS nombreTercero, ISNULL(c.sueldo, cc.salario) AS sueldo, b.concepto AS codConcepto, s.descripcion AS nombreConcepto, a.tipo, a.numero, a.año, a.mes, a.fecha, a.fechaRegistro, a.usuario, 
