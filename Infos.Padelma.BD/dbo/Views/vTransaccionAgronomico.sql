...
SELECT DISTINCT 
                         ...
                         CASE WHEN b.signo = 1 THEN c.cantidad ELSE c.cantidad END AS cantidadTercero, c.jornales AS jornalTercero, c.precioLabor, n.codigo AS codCargo, n.descripcion AS nombreCargo, o.codigo AS codCCosto, 
                         ...
                         CASE WHEN b.signo = 1 THEN c.valorTotal ELSE c.valorTotal END AS valorTotalTercero, k.añoSiembra, k.palmasBrutas, k.palmasProduccion, x.codigo AS codGrupoLabor, x.descripcion AS nombreGrupoLabor, 
                         c.contrato, k.hBrutas, k.hNetas, c.contratista, c.periodo, c.ejecutado AS ejecutadoNomina
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[23] 4[38] 2[29] 3) )"
      End
