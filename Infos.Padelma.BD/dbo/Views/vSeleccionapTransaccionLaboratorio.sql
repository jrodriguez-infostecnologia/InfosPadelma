...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vSeleccionapTransaccionLaboratorio';
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "pTransaccionJerarquiaAnalisis"
            Begin Extent = 
               Top = 6
               Left = 285
               Bottom = 135
            ...
            TopColumn = 0
         End
         Begin Table = "pTransaccionJerarquia"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 188
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vSeleccionapTransaccionLaboratorio';
