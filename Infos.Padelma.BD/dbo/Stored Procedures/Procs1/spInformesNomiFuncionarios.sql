...
l.direccion,case when  d.mSindicato=1 then 'X' else '' end sindical,
case when  d.mFondoEmpleado=1 then 'X' else '' end fondoEmpleado,
case when  d.pactoColectivo=1 then 'X' else '' end pactoColectivo,
l.telefono,
case when  a.contratista=1 then 'X' else '' end contratista,
m.descripcion nombreContratista,
...
left join cTercero m on m.empresa=a.empresa and m.id=a.proveedor
