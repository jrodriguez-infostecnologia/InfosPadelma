...
insert gParametrosGenerales( empresa,entradas,entradasAlt,salidas,salidasAlt,pesajes,pesajesAlt,fruta,frutaAlt,almendra,almedraAlt,nuez,nuezAlt,crudo,crudoAlt,palmiste,palmisteAlt,blanqueado,blanqueadoAlt,cascarilla,cascarillaAlt,torta,tortaAlt,raquiz,raquizAlt,raquizPrensado,raquizPrensadoAlt,fibra,fibraAlt,tiquete,tiqueteAlt,ordenEnvio,ordenEnvioAlt,remisionComer,remisionComerAlt,remisionInt,remisionIntAlt,ordenSalida,ordenSalidaAlt,
anulado	,
anuladoAlt	,
frutaDura	,
frutaDuraAlt,	
...
impurezasAlt	
 ...
 select @empresa,@entradas,@entradasAlt,@salidas,@salidasAlt,@pesajes,@pesajesAlt,@fruta,@frutaAlt,@almendra,@almedraAlt,@nuez,@nuezAlt,@crudo,@crudoAlt,@palmiste,@palmisteAlt,@blanqueado,@blanqueadoAlt,@cascarilla,@cascarillaAlt,@torta,@tortaAlt,@raquiz,@raquizAlt,@raquizPrensado,@raquizPrensadoAlt,@fibra,@fibraAlt,@tiquete,@tiqueteAlt,@ordenEnvio,@ordenEnvioAlt,@remisionComer,@remisionComerAlt,@remisionInt,@remisionIntAlt,@ordenSalida,@ordenSalidaAlt,
@anulado	,
@anuladoAlt	,
@frutaDura	,
@frutaDuraAlt,	
