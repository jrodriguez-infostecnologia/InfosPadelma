...
@manejaBascula bit,@tipoTransaccion varchar(50),@formatoImpresion varchar(250),@dsReferenciaDetalle varchar(250), @mtercero bit,@Retorno int output  AS begin tran gTipoTransaccionConfig 
...
mTipoLiquidacionNomina=@mTipoLiquidacionNomina , tipoLiquidacionNomina=@tipoLiquidacionNomina, mtercero=@mtercero
