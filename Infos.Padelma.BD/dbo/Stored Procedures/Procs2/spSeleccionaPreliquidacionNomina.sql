...
and año=a.año and mes=a.mes  and a.noPeriodo=noPeriodo and nocontrato=a.nocontrato) TotalDevendado,
(select sum(valorConcepto) from  vSeleccionaPreliquidacion where codTercero=a.codTercero and empresa=a.empresa and signo=2
and año=a.año and mes=a.mes  and a.noPeriodo=noPeriodo and nocontrato=a.nocontrato) TotalDeducido,
...
and a.fechaFinal
 and b.concepto=a.codConcepto and a.codTercero=b.tercero --and a.signo=b.signo
...
select   a.identificacion, a.codTercero, a.nombreTercero, a.codCCosto, a.nombreCcosto, a.sueldo, a.nombreCargo, a.codConcepto,
 ...
 case when a.mostrarFecha=1 then a.fecha else null end fecha, a.fechaInical, a.fechaFinal, a.año,
  a.mes, a.periodoUnido, a.nombreMes, a.nombreDepartamento, a.codDepto, a.signo, a.empresa, a.entidadEps, a.entidadPension, a.nombreEPS,
   ...
   isnull(b.cantidad,a.cantidad) cantLabor,
	b.precioLabor precioLabor,isnull(b.desLabor,a.nombreConcepto) desLabor,b.lote,isnull(b.fechaLabor,a.fecha )fechaLabor  ,b.jornales , 
(select sum(valorConcepto) from  vSeleccionaPreliquidacion where codTercero=a.codTercero and empresa=a.empresa and signo=1 and nocontrato=a.nocontrato) TotalDevendado,
(select sum(valorConcepto) from  vSeleccionaPreliquidacion where codTercero=a.codTercero and empresa=a.empresa and signo=2 and nocontrato=a.nocontrato) TotalDeducido,
...
if @empresa > 10
	...
	--where mDomingo=0 ---Nota de Alirio: Por favor no quitar este wherezz
else
	select * from @temporal
	where mDomingo=0 ---Nota de Alirio: Por favor no quitar este wherezz