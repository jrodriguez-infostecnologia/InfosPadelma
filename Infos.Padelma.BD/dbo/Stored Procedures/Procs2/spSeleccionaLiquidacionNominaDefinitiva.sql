...
and año=a.año and mes=a.mes and a.numero = numero and a.tipo=tipo and a.noPeriodo=noPeriodo and contrato=a.contrato) TotalDevendado,
...
and año=a.año and mes=a.mes and a.numero = numero and a.tipo=tipo and a.noPeriodo=noPeriodo and contrato=a.contrato) TotalDeducido,
NULL,isnull(NULL, datename(WEEKDAY,a.fecha)) diaSemana, 0 TotalLabor,
'' numero,'',
a.fechaInicial fip,a.fechaFinal ffp, isnull(a.tipoConcepto,'') tipoConcepto, isnull(a.desTipoConcepto,'') destipoConcepto,0, mDomingo,a.contrato
...
case when a.mostrarFecha=1 then a.fechaConcepto else null end fecha, a.fechaInicial fechaInical, a.fechaFinal, a.año,
  a.mes, a.periodoUnido, a.nombreMes, a.nombreDepartamento, a.codDepto, a.signo, a.empresa, a.entidadEps, a.entidadPension, a.nombreEPS,
   ...
   isnull(b.cantidad,a.cantidad) cantLabor,
	b.precioLabor precioLabor,isnull(b.desLabor,a.nombreConcepto) desLabor,b.lote,isnull(b.fechaLabor,a.fecha )fechaLabor  ,b.jornales , 0 TotalDevendado,0 TotalDeducido,
...
a.fechaInicial fip,a.fechaFinal ffp, isnull(a.tipoConcepto,'') tipoConcepto, isnull(a.desTipoConcepto,'') destipoConcepto,b.racimos, mDomingo,a.contrato
from vSeleccionaLiquidacionDefinitiva a
