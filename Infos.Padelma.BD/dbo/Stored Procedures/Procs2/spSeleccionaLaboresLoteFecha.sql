...
añoSiembra, palmasBrutas, palmasProduccion, contratista
from vTransaccionAgronomico 
where convert(date,fechaTransaccion) between @fi and @ff and codEmpresa=@empresa and anulado=0
group by codGrupoLabor,nombreGrupoLabor,codLote,nombreLote,nombreLabor,codLabor,uMedida,precioLabor, fechaLabor,añoSiembra, palmasBrutas, palmasProduccion,contratista