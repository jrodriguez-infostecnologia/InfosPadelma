...
@entidadSindicato varchar(50), @porFondoEmpleado decimal(18,2), @entidadFE varchar(50), @conceptoFondoSolidaridad varchar(50)
...
@codigoEmbargo varchar(50),@TipoEmbargo varchar(50),@desTipoEmbargo varchar(250)
...
select @conceptoVacaciones = vacaciones, @conceptoSalud=salud, @conceptoPension=pension, @conceptoFondoSolidaridad= fondoSolidaridad from nParametrosGeneral
...
select @NSI = noSalarioIntegral,@JD= jornadaDiaria, @conceptoGanaDomingo =jornales from nParametrosGeneral where empresa=@empresa
	...
	select @tipoLiquidacionNomina=tipoLiquidacion, @signo=signo, @baseSeguridadSocial=baseSeguridadSocial, @baseEmbargosNomina=baseEmbargo, @porcentajeConcepto=porcentaje, @manejaPorcentaje=validaPorcentaje from nconcepto
		...
		select @empresa, @tercero, @centroCosto, @fecha, @departamento, @conceptoVacaciones, @año, @mes, @periodo, @cantidad,@porcentajeConcepto, @valorUnitario,@valorUnitario*@cantidad,@signo, 0, @noDias, @fechaInicial, @fechaFinal, @baseSeguridadSocial, @baseEmbargosNomina,null,0, null
	end
		...
		-- Liquida Seguridad Social Pension
			...
			where empresa = @empresa and codigo=@entidadPension
				...
				begin
					...
					begin
						insert  tmpliquidacionNominaVacaciones 
						select @empresa, @tercero, @centroCosto, @fecha, @departamento, @conceptoPension, @año, @mes, @periodo,1, @porcentajeConcepto, @valorBaseSeguridadSocial, SUM(valorTotal)*@porcentajeConcepto/100, @signo, 0, @noDias, @fechaInicial, @fechaFinal, @baseSeguridadSocial, @baseEmbargosNomina,@terceroEntidad,0, null
			...
			where empresa = @empresa and codigo=@entidadEps
				...
				begin
					...
					begin
						insert  tmpliquidacionNominaVacaciones 
						select @empresa, @tercero, @centroCosto, @fecha, @departamento, @conceptoSalud, @año, @mes, @periodo,1, @porcentajeConcepto, @valorBaseSeguridadSocial, SUM(valorTotal)*@porcentajeConcepto/100, @signo, 0, @noDias, @fechaInicial, @fechaFinal, @baseSeguridadSocial, @baseEmbargosNomina,@terceroEntidad,0, null
						from tmpliquidacionNominaVacaciones where baseSeguridadSocial=1 and tercero=@tercero and empresa=@empresa
					end
				end
				else
			...
			-- prestamos para vacaciones
				...
				declare curPrestamo insensitive cursor for
					select valorCuotas,	a.valorSaldo, a.concepto,signo, a.codigo from nPrestamo a join
						...
						where a.empleado=@tercero and a.empresa=@empresa and valorSaldo>0 
						and (convert(varchar,año)+rtrim(RIGHT('00' + rtrim(periodoInicial), 2))) <= ( convert(varchar,@año)+rtrim(RIGHT('00' + convert(varchar,@periodo), 2)))  -- le fataba el rigth para completar los ceros del periodo ricardo gomez 14/02/2017
					open curPrestamo			
					...
					begin	
						...
						insert  tmpliquidacionNominaVacaciones 
						select @empresa, @tercero, @centroCosto, @fecha, @departamento, @concepto, @año, @mes, @periodo, 1,0, @valorUnitario,@valorUnitario,signo, @valorSaldo - @valorUnitario, @noDias, @fechaInicial, @fechaFinal,baseSeguridadSocial, baseEmbargo,null,@codigo,null
				...
				begin
					...
					from tmpliquidacionNominaVacaciones where baseEmbargos = 1 and tercero=@tercero and empresa=@empresa) 
						...
						exec spliquidaEmbargosNomina  @empresa,@tercero, @valorBaseEmbargo, @pagominimo , @noDias,@periodo ,
						@año , @codigoEmbargo , @valorUnitario output
						
						insert  tmpliquidacionNominaVacaciones 
						select @empresa, @tercero, @centroCosto, @fecha, @departamento, @conceptoEmbargo, @año, @mes, @periodo, 1,0, @valorUnitario,@valorUnitario,signo, 0, @noDias, @fechaInicial, @fechaFinal,baseSeguridadSocial, @baseEmbargosNomina,null,0, @codigoEmbargo
					...
					where codigo=@entidadSindicato and empresa=@empresa
						...
						insert  tmpliquidacionNominaVacaciones 
						select @empresa, @tercero, @centroCosto, @fecha, @departamento, @conceptoSindicato, @año, @mes, @periodo,1, @porSindicato, @valorBaseSeguridadSocial, SUM(valorTotal)*@porSindicato/100, @signo, 0, @noDias, @fechaInicial, @fechaFinal, 0 , 0,@terceroEntidad,0,null
			...
			begin
					...
					insert  tmpliquidacionNominaVacaciones 
					select @empresa, @tercero, @centroCosto, @fecha, @departamento, @conceptoFondo, @año, @mes, @periodo,1, @porSindicato, @valorDiaSueltoTercero, (@valorDiaSueltoTercero* @noDias)*@porFondoEmpleado/100, signo, 0, @noDias, @fechaInicial, @fechaFinal, 0 , 0,@entidadFE,0,null
			...
			if exists (select * from nparametrosgeneral where  fondoSolidaridad = @conceptoFondoSolidaridad and empresa=@empresa  )  
			begin
			--select 'paso'
				declare @valorbaseFS int=0
				set @valorbaseFS =isnull((select sum(valorTotal) from vSeleccionaRealLiquidacionVaca where empresa=@empresa and baseSeguridadSocial=1 and tercero=@tercero),0)
				set @porcentajeConcepto = isnull((select top 1 porcentaje from nConceptoRango where empresa=@empresa and concepto=@conceptoFondoSolidaridad and @valorbaseFS/@noDias between minimo/@noDias and maximo/@noDias),0)
				set @manejaPorcentaje = isnull((select top 1 por from nConceptoRango where empresa=@empresa and concepto=@conceptoFondoSolidaridad and @valorbaseFS/@noDias  between minimo/@noDias and maximo/@noDias),0)
				...
				begin
					...
					begin
					insert  tmpliquidacionNominaVacaciones 
					select @empresa, @tercero, @centroCosto, @fecha, @departamento, @conceptoFondoSolidaridad, @año, @mes, @periodo,1, @porcentajeConcepto, @valorBaseSeguridadSocial, round((SUM(@valorbaseFS)*@porcentajeConcepto/100),0), @signo, 0, @noDias, @fechaInicialLiquidacion, @fechaFinalLiquidacion, @baseSeguridadSocial, @baseEmbargo,@entidadEPS,0,0
					from vSeleccionaRealLiquidacionVaca where tercero=@tercero and empresa=@empresa and baseSeguridadSocial=1
					end
				end
			...
			begin			
				...
				--select 'entro'
				insert  tmpliquidacionNominaVacaciones 
				select @empresa, @tercero, @centroCosto, @fecha, @departamento, @concepto, @año, @mes, @periodo,@cantidadNovedad, @porSindicato, @valorUnitario, @valorUnitario, @signo, 0, @noDias, @fechaInicial, @fechaFinal, 0 , 0,@entidadFE,0,null
