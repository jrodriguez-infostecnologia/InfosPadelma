...
select a.identificacion, a.codTercero, a.nombreTercero, a.codCCosto, a.nombreCcosto, a.sueldo, a.nombreCargo, a.codConcepto,
 a.nombreConcepto, a.cantidad,a.valorTotal  valorConcepto, case when  a.saldo=0 then null else a.saldo end saldo, a.noPeriodo, 
 case when a.mostrarFecha=1 then a.fecha else null end fecha, a.fechaInicial, a.fechaFinal, a.año,
...
(select sum(valorTotal) from  vSeleccionaLiquidacionDefinitiva where codTercero=a.codTercero and empresa=a.empresa and signo=1 and anulado=0 and año=a.año and mes=a.mes and noPeriodo=a.noPeriodo) TotalDevendado,
(select sum(valorTotal) from  vSeleccionaLiquidacionDefinitiva where codTercero=a.codTercero and empresa=a.empresa and signo=2 and anulado=0 and año=a.año and mes=a.mes and noPeriodo=a.noPeriodo) TotalDeducido,
