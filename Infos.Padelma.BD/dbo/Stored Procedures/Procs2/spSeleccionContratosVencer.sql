...
prorroga1 date,prorroga2 date,prorroga3 date, fechaPreaviso date, diasAviso int,noContrato int,nombreClaseContrato varchar(550)
	...
	select tercero,fechaIngreso,diasContrato,b.descripcion, b.codigo,a.id,c.descripcion,a.fechaContratoHasta
	 from nContratos a
	...
	open curContratos			
	fetch curContratos into @tercero,@fechaIngreso,@diasContrato,@nombreTercero,@codTercero,@noContrato,@nombreClaseContrato,@fechaTerminacion
	...
	begin	
		...
		set @preAviso =dateadd(DAY,-30,@fechaTerminacion)
