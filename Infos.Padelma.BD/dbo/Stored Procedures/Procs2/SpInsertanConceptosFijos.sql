...
@lDomingoCero bit,@mDomingo bit,@lsindicato bit,@ldomingoPromedio bit, @lfestivoPromedio bit,
@usuario varchar(50),@lNovedadesCredito bit,@lFondavi bit,@lDomingo bit, @lfestivo bit,@Retorno int output  AS begin tran nConceptosFijos
 ...
 lAusentismo,lEmbargo,lOtros,centroCosto,observacion,usuario,lNovedadesCredito,lFondavi,lDomingo,lFestivo,lDomingoCero,mDomingo,lSindicato,lDomingoPromedio,lFestivoPromedio ) 
 ...
 @ldomingoPromedio,@lfestivoPromedio
