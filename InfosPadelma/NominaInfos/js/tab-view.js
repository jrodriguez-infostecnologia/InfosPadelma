...
************************************************************************************************************/
	...
	function initTabs(mainContainerID,tabTitles,activeTab,width,height,closeButtonArray,additionalTab)
	{
		...
		if(!additionalTab || additionalTab=='undefined'){
			...
			var firstDiv =null;// dhtmlgoodies_tabObj[mainContainerID].getElementsByTagName('DIV')[0];
	...
	function createNewTab(parentId,tabTitle,tabContent,tabContentUrl,closeButton)
	{
		...
		if(tabContent)div.innerHTML = "<iframe src="+tabContentUrl+" border='0' width='100%' height='100%'> </iframe>";
		
		
		if(tabContentUrl){
			var ajaxIndex = ajaxObjects.length;
			ajaxObjects[ajaxIndex] = new sack();
			//ajaxObjects[ajaxIndex].requestFile = tabContent;	// Specifying which file to get
