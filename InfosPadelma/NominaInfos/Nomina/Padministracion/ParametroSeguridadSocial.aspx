<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ParametroSeguridadSocial.aspx.cs" Inherits="Agronomico_Padministracion_Cuadrillas" %>
        ...
        <div class="principal">
            ...
            <table cellspacing="0" style="width: 100%; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: silver;" id="Table2">
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:DropDownList ID="ddlTipo" runat="server" AutoPostBack="True" CssClass="chzn-select" data-placeholder="Seleccione una opción..." OnSelectedIndexChanged="ddlTipo_SelectedIndexChanged" Width="350px" Visible="False">
                            <asp:ListItem Value="1">Conceptos suman valor IBC</asp:ListItem>
                            <asp:ListItem Value="2">Conceptos suman días IBC</asp:ListItem>
