<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GrupoIR.aspx.cs" Inherits="Contabilidad_Padministracion_IR" %>
        ...
        <div class="principal">
            ...
            <table cellspacing="0" style="width: 1000px; border-top: silver thin solid; border-bottom: silver thin solid;" id="TABLE1">
                ...
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos" style="vertical-align: top">
                        <asp:Label ID="Label5" runat="server" Text="Seleccione Imp/Rete" Visible="False"></asp:Label>
                    </td>
                    <td class="Campos"></td>
                    <td class="bordes"></td>
                </tr>
