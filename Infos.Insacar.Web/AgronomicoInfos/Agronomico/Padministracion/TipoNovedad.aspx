<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TipoNovedad.aspx.cs" Inherits="Agronomico_Padministracion_TipoNovedad" %>
                ...
                <tr>
                    ...
                    <td colspan="4" style="text-align: center">
                        <div style="display: inline-block">
                            ...
                            <select runat="server" id="selNovedades" class="multiselect" multiple="true" name="countries[]" visible="False">
                            </select>
                        </div>
                    </td>
                </tr>
                ...
                <div style="display: inline-block">
                    <asp:GridView ID="gvLista" runat="server" Width="700px" GridLines="None" CssClass="Grid" OnSelectedIndexChanged="gvLista_SelectedIndexChanged" OnRowDeleting="gvLista_RowDeleting" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanging="gvLista_PageIndexChanging" PageSize="20">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="tipo" HeaderText="C&#243;digo" ReadOnly="True">
