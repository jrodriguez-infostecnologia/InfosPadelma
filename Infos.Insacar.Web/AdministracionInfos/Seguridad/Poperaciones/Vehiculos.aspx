        ...
        <div class="principal">
            ...
            <table cellspacing="0" style="width: 950px; border-top: silver thin solid; border-bottom: silver thin solid;" id="TABLE1">
                ...
                <tr>
                    ...
                    <td class="Campos">
                        <asp:TextBox ID="txtPesoTara" runat="server" CssClass="input" Width="150px" TextMode="Number" ValidateRequestMode="Enabled" ViewStateMode="Enabled" onkeyup="formato_numero(this)" Visible="False"></asp:TextBox>
                    </td>
                    <td class="bordes"></td>
                </tr>
                <tr>
