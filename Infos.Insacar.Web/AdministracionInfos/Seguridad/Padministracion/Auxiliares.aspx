    ...
    <form id="form1" runat="server">
        <div class="principal">
            <table cellspacing="0" style="width: 950px">
                <tr>
                    <td class="bordes"></td>
                    <td class="nombreCampos">Entidad</td>
                    <td class="Campos">
                        <asp:DropDownList ID="niddlEntidad" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlEntidad_SelectedIndexChanged" data-placeholder="Seleccione una opción..."  CssClass="chzn-select"
                            Width="300px">
                        </asp:DropDownList></td>
                    <td class="bordes"></td>
                </tr>
