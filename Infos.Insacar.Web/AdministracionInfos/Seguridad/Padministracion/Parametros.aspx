<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Parametros.aspx.cs" Inherits="Facturacion_Padministracion_Clientes1"  %>
        ...
        <table cellspacing="0" style="width: 950px; border-top: silver thin solid; border-bottom: silver thin solid;" id="TABLE1">
            ...
            <tr>
                <td >
                    &nbsp;</td>
                <td class="nombreCampos" >
                    <asp:Label ID="Label3" runat="server" CssClass="label" Text="Valor" Visible="False"></asp:Label>
                </td>
                <td class="Campos" >
                    <asp:TextBox ID="txtValor" runat="server" CssClass="input" Visible="False" Width="300px"></asp:TextBox>
                </td>
                <td >
                    &nbsp;</td>
            </tr>
