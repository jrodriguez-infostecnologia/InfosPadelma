<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Perfiles.aspx.cs" Inherits="Facturacion_Padministracion_Perfiles"  %>
            ...
            <div style="display:inline-block"> 
                    <asp:GridView ID="gvLista" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="Grid" OnRowDeleting="gvLista_RowDeleting" OnSelectedIndexChanged="gvLista_SelectedIndexChanged" PageSize="20" Width="600px" OnPageIndexChanging="gvLista_PageIndexChanging">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="codigo" HeaderText="Perfil" >
                            ...
                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="50px" CssClass="Items" />
                            </asp:CheckBoxField>
                        </Columns>
