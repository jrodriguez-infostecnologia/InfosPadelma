...
SELECT        a.empresa, a.año, a.mes, DATENAME(MONTH, a.fecha) AS nombreMes, a.fecha, a.tipo, f.descripcion AS nombreTransaccion, a.numero, a.referencia, a.finca, i.descripcion AS nombreFinca, a.remision, 
                         ...
                         b.racimos AS racimoLabor, b.saldo AS saldoLabor, b.ejecutado, b.signo, a.anulado, k.añoSiembra, k.mesSiembra, k.palmasBrutas, k.palmasProduccion, k.hBrutas, k.hNetas, d.desCorta, d.claseLabor, k.variedad, 
                         j.descripcion AS nombreVariedad, k.seccion AS Expr1
FROM            dbo.aTransaccion AS a LEFT OUTER JOIN
                         ...
                         dbo.aVariedad AS j ON j.codigo = k.variedad AND j.empresa = k.empresa
GO
