...
*****************************************************************************/
	...
	select @conteo = COUNT(*)
	from bRemision	where codigo = @codigo and	empresa=@empresa and estado = 'U' and
	codigo in ( select remision from bRegistroBascula 
	where estado in ( 'PP','SP' ) and analisisRegistrado = 0 and empresa=@empresa  and remision=@codigo)
