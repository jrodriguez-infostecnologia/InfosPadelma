CREATE PROCEDURE [dbo].[spSeleccionaTransaccionCompletapTransaccion]
	@where text,
	@empresa int
AS
/***************************************************************************
...
*****************************************************************************/
	...
	set @select = 'select distinct tipo, numero, fecha, producto, nota, año, mes, anulado,nombreProducto
	from vSeleccionapTransaccionProduccion'
