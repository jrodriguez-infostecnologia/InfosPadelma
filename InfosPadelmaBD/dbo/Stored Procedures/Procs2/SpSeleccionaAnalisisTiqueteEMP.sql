...
*****************************************************************************/
	...
	select upper(N.descripcion) as nombre,A.valor,upper( C.descripcion ) as nombreUsuario,A.fecha,d.desCorta  uMedida
	from lRegistroAnalisis A
	join iItems N on  A.analisis = N.codigo and a.empresa=n.empresa
	join gUnidadMedida d on d.codigo=N.uMedidaConsumo and d.empresa=n.empresa
