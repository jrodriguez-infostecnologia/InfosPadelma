...
join nLiquidacionNominaDetalle b on b.numero=a.numero and b.tipo=a.tipo and a.empresa=b.empresa
 ...
 join cCentrosCosto d on d.codigo=b.ccosto and d.empresa=b.empresa 
...
where  a.empresa=@empresa and a.anulado=0 
and a.numero like  '%'+@numero+'%' and a.tipo='LQC'
