...
@tipoTransaccion varchar(50),@formatoImpresion varchar(250),@dsReferenciaDetalle varchar(250),@mtercero bit,@Retorno int output  AS begin tran gTipoTransaccionConfig 
...
estudioCompra,registroProveedor,fechaActual,manejaBascula,tipoTransaccion,formatoImpresion,dsReferenciaDetalle ,mTipoLiquidacionNomina,tipoLiquidacionNomina,mtercero) 
...
@registroProveedor,@fechaActual,@manejaBascula,@tipoTransaccion,@formatoImpresion,@dsReferenciaDetalle,@mTipoLiquidacionNomina,@tipoLiquidacionNomina, @mtercero
